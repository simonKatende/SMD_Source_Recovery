...
public class TableAdapterManager : Component
{
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_staffTableAdapter != null && _staffTableAdapter.Connection != null)
			{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(dSetStaff dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_staffTableAdapter != null)
		{
			DataRow[] updatedRows = dataSet.Staff.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _staffTableAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(dSetStaff dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_staffTableAdapter != null)
		{
			DataRow[] array = dataSet.Staff.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _staffTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(dSetStaff dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_staffTableAdapter != null)
		{
			DataRow[] array = dataSet.Staff.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _staffTableAdapter.Update(array);
	...
	public virtual int UpdateAll(dSetStaff dataSet)
	{
		...
		if (_staffTableAdapter != null && !MatchTableAdapterConnection(_staffTableAdapter.Connection))
		{
		...
		try
		{
			if (_staffTableAdapter != null)
			{
				dictionary.Add(_staffTableAdapter, _staffTableAdapter.Connection);
				_staffTableAdapter.Connection = (SqlConnection)connection;
				_staffTableAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_staffTableAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_staffTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_staffTableAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_staffTableAdapter != null)
			{
				_staffTableAdapter.Connection = (SqlConnection)dictionary[_staffTableAdapter];
