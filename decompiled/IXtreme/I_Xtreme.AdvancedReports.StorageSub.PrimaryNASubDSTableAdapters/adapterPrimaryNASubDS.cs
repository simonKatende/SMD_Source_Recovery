...
public class adapterPrimaryNASubDS : Component
{
	...
	private void InitAdapter()
	{
		...
		dataTableMapping.DataSetTable = "PrimaryNASubDS";
	...
	public virtual int Fill(PrimaryNASubDS.PrimaryNASubDSDataTable dataTable)
	{
	...
	public virtual PrimaryNASubDS.PrimaryNASubDSDataTable GetData()
	{
		Adapter.SelectCommand = CommandCollection[0];
		PrimaryNASubDS.PrimaryNASubDSDataTable primaryNASubDSDataTable = new PrimaryNASubDS.PrimaryNASubDSDataTable();
		Adapter.Fill(primaryNASubDSDataTable);
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual int Update(PrimaryNASubDS.PrimaryNASubDSDataTable dataTable)
	{
	...
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	[HelpKeyword("vs.data.TableAdapter")]
	public virtual int Update(PrimaryNASubDS dataSet)
	{
		return Adapter.Update(dataSet, "PrimaryNASubDS");
	}
