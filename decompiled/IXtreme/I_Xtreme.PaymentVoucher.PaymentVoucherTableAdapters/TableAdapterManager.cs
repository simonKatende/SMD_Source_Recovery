...
public class TableAdapterManager : Component
{
	...
	private PaymentVoucherTableAdapter _paymentVoucherTableAdapter;
	...
	public PaymentVoucherTableAdapter PaymentVoucherTableAdapter
	{
		get
		{
			return _paymentVoucherTableAdapter;
		}
		set
		{
			_paymentVoucherTableAdapter = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_paymentVoucherTableAdapter != null && _paymentVoucherTableAdapter.Connection != null)
			{
				return _paymentVoucherTableAdapter.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_paymentVoucherTableAdapter != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(PaymentVoucher dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_paymentVoucherTableAdapter != null)
		{
			DataRow[] updatedRows = dataSet._PaymentVoucher.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _paymentVoucherTableAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(PaymentVoucher dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_paymentVoucherTableAdapter != null)
		{
			DataRow[] array = dataSet._PaymentVoucher.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _paymentVoucherTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(PaymentVoucher dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_paymentVoucherTableAdapter != null)
		{
			DataRow[] array = dataSet._PaymentVoucher.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _paymentVoucherTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(PaymentVoucher dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_paymentVoucherTableAdapter != null && !MatchTableAdapterConnection(_paymentVoucherTableAdapter.Connection))
		{
		...
		try
		{
			if (_paymentVoucherTableAdapter != null)
			{
				dictionary.Add(_paymentVoucherTableAdapter, _paymentVoucherTableAdapter.Connection);
				_paymentVoucherTableAdapter.Connection = (SqlConnection)connection;
				_paymentVoucherTableAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_paymentVoucherTableAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_paymentVoucherTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_paymentVoucherTableAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_paymentVoucherTableAdapter != null)
			{
				_paymentVoucherTableAdapter.Connection = (SqlConnection)dictionary[_paymentVoucherTableAdapter];
				_paymentVoucherTableAdapter.Transaction = null;
			}
			if (0 < list3.Count)
			{
