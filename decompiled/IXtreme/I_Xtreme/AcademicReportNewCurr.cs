...
using I_Xtreme.NewCurriculumReports;
using I_Xtreme.SubReport;

namespace I_Xtreme;

public class AcademicReportNewCurr : RibbonForm
{
	private string schoolType = SchoolSettings.SchoolGeneralCurriculum.ToString();

	private MainReportNewCurLO mainReportNewCur;

	private MainReportNewCur2080 mainReportNewCur2080;

	private DescriptiveUltimatev1 nCDescriptivev2;

	private DescriptiveUltimatev2 nCDescriptivev3;

	private MainReportEOY ncMainReportEOY;

	private StudentsDetailsLS reportLandscape;

	private UltimateReport ultimateReport;

	private MainLOReportProject reportProj;

	private bool showUnAssessed = false;

	private bool showClassRank = false;

	private bool showStreamRank = false;
	...
	private PrintPreviewBarItem printPreviewBarPrint;

	private PrintPreviewBarItem printPreviewBarQuickPrint;
	...
	private PrintPreviewBarItem printPreviewWaterMark;

	private PrintPreviewBarItem printPreviewBarExport;

	private PrintPreviewBarItem printPreviewBarEmail;
	...
	public BarStaticItem lblReportText;

	private RibbonPageGroup ribbonPageGroup1;

	public AcademicReportNewCurr(string __Class, string __Semester, int viewMode)
	{
		SplashScreenManager.ShowForm(this, typeof(WaitForm1), useFadeIn: false, useFadeOut: false, throwExceptionIfAlreadyOpened: false);
		SplashScreenManager.Default.SetWaitFormDescription("Initializing Report Viewer...");
		SplashScreenManager.Default.SendCommand(WaitForm1.WaitFormCommand.LoadAcademicReport, 0);
		Thread.Sleep(25);
		InitializeComponent();
		_Class = __Class;
		...
		{
			printPreviewRibbonPageGroup2.Visible = true;
			printPreviewRibbonPageGroup7.Visible = true;
			Text = $"School Management Dynamics - ({_Class} Report Cards - {_Semester})";
		}
		else
		{
			printPreviewRibbonPageGroup2.Visible = false;
			printPreviewRibbonPageGroup7.Visible = false;
			Text = $"TRIAL PERIOD EXPIRED, THEREFORE YOU CANNOT PRINT REPORTS";
		}
		LoadReport();
	...
	private void LoadReport()
	{
		try
		{
			mainReportNewCur = new MainReportNewCurLO(showUnAssessed);
			mainReportNewCur2080 = new MainReportNewCur2080(showUnAssessed, showClassRank, showStreamRank);
			reportLandscape = new StudentsDetailsLS();
			nCDescriptivev2 = new DescriptiveUltimatev1();
			nCDescriptivev3 = new DescriptiveUltimatev2();
			ultimateReport = new UltimateReport();
			ncMainReportEOY = new MainReportEOY(showUnAssessed, viewMode);
			reportProj = new MainLOReportProject(showUnAssessed);
			string text = _Class.Replace('.', '_') + " Report Card_" + _Semester;
			if (viewMode == 0)
			{
				printControl1.PrintingSystem = mainReportNewCur.PrintingSystem;
				mainReportNewCur.DisplayName = text;
				mainReportNewCur.Bookmark = text;
				mainReportNewCur.CreateDocument();
			}
			else if (viewMode == 1)
			{
				printControl1.PrintingSystem = mainReportNewCur2080.PrintingSystem;
				mainReportNewCur2080.DisplayName = text;
				mainReportNewCur2080.Bookmark = text;
				mainReportNewCur2080.CreateDocument();
			}
			else if (viewMode == 2)
			{
				printControl1.PrintingSystem = reportLandscape.PrintingSystem;
				reportLandscape.DisplayName = text;
				reportLandscape.Bookmark = text;
				reportLandscape.CreateDocument();
			}
			else if (viewMode == 3)
			{
				printControl1.PrintingSystem = nCDescriptivev2.PrintingSystem;
				nCDescriptivev2.DisplayName = text;
				nCDescriptivev2.Bookmark = text;
				nCDescriptivev2.CreateDocument();
			}
			else if (viewMode == 4)
			{
				printControl1.PrintingSystem = nCDescriptivev3.PrintingSystem;
				nCDescriptivev3.DisplayName = text;
				nCDescriptivev3.Bookmark = text;
				nCDescriptivev3.CreateDocument();
			}
			else if (viewMode == 5)
			{
				printControl1.PrintingSystem = ncMainReportEOY.PrintingSystem;
				ncMainReportEOY.DisplayName = text;
				ncMainReportEOY.Bookmark = text;
				ncMainReportEOY.CreateDocument();
			}
			else if (viewMode == 6)
			{
				printControl1.PrintingSystem = ultimateReport.PrintingSystem;
				ultimateReport.DisplayName = text;
				ultimateReport.Bookmark = text;
				ultimateReport.CreateDocument();
			}
			else if (viewMode == 7)
			{
				printControl1.PrintingSystem = reportProj.PrintingSystem;
				reportProj.DisplayName = text;
				reportProj.Bookmark = text;
				reportProj.CreateDocument();
			}
		}
		catch (Exception ex)
		{
	...
	private void AcademicReport_KeyDown(object sender, KeyEventArgs e)
	{
		if (LicenceStatus.IsTrialExpired && e.KeyCode == Keys.P && e.Control)
		{
			XtraMessageBox.Show("(Ctrl + P) is disabled because your license expired.", "School Management Dynamics", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
			e.Handled = false;
		}
	}
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(I_Xtreme.AcademicReport));
		...
		this.printPreviewBarPrint = new DevExpress.XtraPrinting.Preview.PrintPreviewBarItem();
		this.printPreviewBarQuickPrint = new DevExpress.XtraPrinting.Preview.PrintPreviewBarItem();
		...
		this.printPreviewWaterMark = new DevExpress.XtraPrinting.Preview.PrintPreviewBarItem();
		this.printPreviewBarExport = new DevExpress.XtraPrinting.Preview.PrintPreviewBarItem();
		this.printPreviewBarEmail = new DevExpress.XtraPrinting.Preview.PrintPreviewBarItem();
		...
		this.lblReportText = new DevExpress.XtraBars.BarStaticItem();
		...
		this.ribbon.Items.AddRange(new DevExpress.XtraBars.BarItem[56]
		{
			...
			this.printPreviewBarPrint,
			this.printPreviewBarQuickPrint,
			...
			this.printPreviewWaterMark,
			this.printPreviewBarExport,
			this.printPreviewBarEmail,
		...
		this.ribbon.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[1] { this.printPreviewRibbonPage1 });
		this.ribbon.QuickToolbarItemLinks.Add(this.lblReportText);
		this.ribbon.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[2] { this.repositoryItemProgressBar1, this.repositoryItemZoomTrackBar1 });
		...
		this.ribbon.Size = new System.Drawing.Size(1616, 186);
		...
		this.printPreviewBarItem1.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_DocumentMap;
		this.printPreviewBarItem1.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_DocumentMapLarge;
		this.printPreviewBarItem1.Name = "printPreviewBarItem1";
		superToolTip.FixedTooltipWidth = true;
		toolTipTitleItem.Text = "Document Map";
		toolTipItem.LeftIndent = 6;
		toolTipItem.Text = "Open the Document Map, which allows you to navigate through a structural view of the document.";
		superToolTip.Items.Add(toolTipTitleItem);
		superToolTip.Items.Add(toolTipItem);
		superToolTip.MaxWidth = 210;
		this.printPreviewBarItem1.SuperTip = superToolTip;
		...
		this.printControl1.Location = new System.Drawing.Point(0, 186);
		this.printControl1.Margin = new System.Windows.Forms.Padding(4);
		this.printControl1.Name = "printControl1";
		this.printControl1.Size = new System.Drawing.Size(1616, 506);
		...
		this.ribbonStatusBar.Size = new System.Drawing.Size(1616, 48);
		...
		this.printPreviewBarItem2.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Parameters;
		this.printPreviewBarItem2.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ParametersLarge;
		...
		this.printPreviewBarItem3.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Find;
		this.printPreviewBarItem3.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_FindLarge;
		...
		this.printPreviewBarItem4.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Customize;
		this.printPreviewBarItem4.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_CustomizeLarge;
		...
		this.printPreviewBarPrint.Caption = "Print";
		this.printPreviewBarPrint.Command = DevExpress.XtraPrinting.PrintingSystemCommand.Print;
		this.printPreviewBarPrint.ContextSpecifier = this.printRibbonController1;
		this.printPreviewBarPrint.Enabled = false;
		this.printPreviewBarPrint.Id = 5;
		this.printPreviewBarPrint.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Print;
		this.printPreviewBarPrint.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PrintLarge;
		this.printPreviewBarPrint.Name = "printPreviewBarPrint";
		...
		this.printPreviewBarPrint.SuperTip = superToolTip5;
		this.printPreviewBarQuickPrint.Caption = "Quick Print";
		this.printPreviewBarQuickPrint.Command = DevExpress.XtraPrinting.PrintingSystemCommand.PrintDirect;
		this.printPreviewBarQuickPrint.ContextSpecifier = this.printRibbonController1;
		this.printPreviewBarQuickPrint.Enabled = false;
		this.printPreviewBarQuickPrint.Id = 6;
		this.printPreviewBarQuickPrint.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PrintDirect;
		this.printPreviewBarQuickPrint.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PrintDirectLarge;
		this.printPreviewBarQuickPrint.Name = "printPreviewBarQuickPrint";
		...
		this.printPreviewBarQuickPrint.SuperTip = superToolTip6;
		...
		this.printPreviewBarItem8.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_EditPageHF;
		this.printPreviewBarItem8.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_EditPageHFLarge;
		...
		this.printPreviewBarItem9.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Scale;
		this.printPreviewBarItem9.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ScaleLarge;
		...
		this.printPreviewBarItem10.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Pointer;
		...
		this.printPreviewBarItem11.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_HandTool;
		...
		this.printPreviewBarItem12.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Magnifier;
		...
		this.printPreviewBarItem13.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ZoomOut;
		this.printPreviewBarItem13.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ZoomOutLarge;
		...
		this.printPreviewBarItem14.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ZoomIn;
		this.printPreviewBarItem14.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ZoomInLarge;
		...
		this.printPreviewBarItem15.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Zoom;
		this.printPreviewBarItem15.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ZoomLarge;
		...
		this.printPreviewBarItem16.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ShowFirstPage;
		this.printPreviewBarItem16.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ShowFirstPageLarge;
		...
		this.printPreviewBarItem17.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ShowPrevPage;
		this.printPreviewBarItem17.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ShowPrevPageLarge;
		...
		this.printPreviewBarItem18.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ShowNextPage;
		this.printPreviewBarItem18.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ShowNextPageLarge;
		...
		this.printPreviewBarItem19.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ShowLastPage;
		this.printPreviewBarItem19.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ShowLastPageLarge;
		...
		this.printPreviewBarItem20.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_MultiplePages;
		this.printPreviewBarItem20.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_MultiplePagesLarge;
		...
		this.printPreviewBarItem21.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_FillBackground;
		this.printPreviewBarItem21.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_FillBackgroundLarge;
		...
		this.printPreviewWaterMark.Caption = "Watermark";
		this.printPreviewWaterMark.Command = DevExpress.XtraPrinting.PrintingSystemCommand.Watermark;
		this.printPreviewWaterMark.ContextSpecifier = this.printRibbonController1;
		this.printPreviewWaterMark.Enabled = false;
		this.printPreviewWaterMark.Id = 22;
		this.printPreviewWaterMark.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Watermark;
		this.printPreviewWaterMark.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_WatermarkLarge;
		this.printPreviewWaterMark.Name = "printPreviewWaterMark";
		...
		this.printPreviewWaterMark.SuperTip = superToolTip22;
		this.printPreviewBarExport.ButtonStyle = DevExpress.XtraBars.BarButtonStyle.DropDown;
		this.printPreviewBarExport.Caption = "Export To";
		this.printPreviewBarExport.Command = DevExpress.XtraPrinting.PrintingSystemCommand.ExportFile;
		this.printPreviewBarExport.ContextSpecifier = this.printRibbonController1;
		this.printPreviewBarExport.Enabled = false;
		this.printPreviewBarExport.Id = 23;
		this.printPreviewBarExport.ImageOptions.Image = (System.Drawing.Image)resources.GetObject("printPreviewBarExport.ImageOptions.Image");
		this.printPreviewBarExport.ImageOptions.LargeImage = (System.Drawing.Image)resources.GetObject("printPreviewBarExport.ImageOptions.LargeImage");
		this.printPreviewBarExport.Name = "printPreviewBarExport";
		...
		this.printPreviewBarExport.SuperTip = superToolTip23;
		this.printPreviewBarEmail.ButtonStyle = DevExpress.XtraBars.BarButtonStyle.DropDown;
		this.printPreviewBarEmail.Caption = "E-Mail As";
		this.printPreviewBarEmail.Command = DevExpress.XtraPrinting.PrintingSystemCommand.SendFile;
		this.printPreviewBarEmail.ContextSpecifier = this.printRibbonController1;
		this.printPreviewBarEmail.Enabled = false;
		this.printPreviewBarEmail.Id = 24;
		this.printPreviewBarEmail.ImageOptions.Image = (System.Drawing.Image)resources.GetObject("printPreviewBarEmail.ImageOptions.Image");
		this.printPreviewBarEmail.ImageOptions.LargeImage = (System.Drawing.Image)resources.GetObject("printPreviewBarEmail.ImageOptions.LargeImage");
		this.printPreviewBarEmail.Name = "printPreviewBarEmail";
		...
		this.printPreviewBarEmail.SuperTip = superToolTip24;
		this.printPreviewBarEmail.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
		this.printPreviewBarItem25.Caption = "Close Preview";
		...
		this.printPreviewBarItem25.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ClosePreview;
		this.printPreviewBarItem25.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ClosePreviewLarge;
		...
		this.printPreviewBarItem26.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PageOrientation;
		this.printPreviewBarItem26.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PageOrientationLarge;
		...
		this.printPreviewBarItem27.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PaperSize;
		this.printPreviewBarItem27.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PaperSizeLarge;
		...
		this.printPreviewBarItem28.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PageMargins;
		this.printPreviewBarItem28.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PageMarginsLarge;
		...
		this.printPreviewBarItem29.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendPdf;
		this.printPreviewBarItem29.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendPdfLarge;
		...
		this.printPreviewBarItem30.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendTxt;
		this.printPreviewBarItem30.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendTxtLarge;
		...
		this.printPreviewBarItem31.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendCsv;
		this.printPreviewBarItem31.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendCsvLarge;
		...
		this.printPreviewBarItem32.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendMht;
		this.printPreviewBarItem32.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendMhtLarge;
		...
		this.printPreviewBarItem33.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendXls;
		this.printPreviewBarItem33.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendXlsLarge;
		...
		this.printPreviewBarItem34.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendXlsx;
		this.printPreviewBarItem34.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendXlsxLarge;
		...
		this.printPreviewBarItem35.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendRtf;
		this.printPreviewBarItem35.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendRtfLarge;
		...
		this.printPreviewBarItem36.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendGraphic;
		this.printPreviewBarItem36.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SendGraphicLarge;
		...
		this.printPreviewBarItem37.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportPdf;
		this.printPreviewBarItem37.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportPdfLarge;
		...
		this.printPreviewBarItem38.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportHtm;
		this.printPreviewBarItem38.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportHtmLarge;
		...
		this.printPreviewBarItem39.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportTxt;
		this.printPreviewBarItem39.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportTxtLarge;
		...
		this.printPreviewBarItem40.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportCsv;
		this.printPreviewBarItem40.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportCsvLarge;
		...
		this.printPreviewBarItem41.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportMht;
		this.printPreviewBarItem41.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportMhtLarge;
		...
		this.printPreviewBarItem42.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportXls;
		this.printPreviewBarItem42.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportXlsLarge;
		...
		this.printPreviewBarItem43.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportXlsx;
		this.printPreviewBarItem43.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportXlsxLarge;
		...
		this.printPreviewBarItem44.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportRtf;
		this.printPreviewBarItem44.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportRtfLarge;
		...
		this.printPreviewBarItem45.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportGraphic;
		this.printPreviewBarItem45.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportGraphicLarge;
		...
		this.printPreviewBarItem46.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Open;
		this.printPreviewBarItem46.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_OpenLarge;
		...
		this.printPreviewBarItem47.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Save;
		this.printPreviewBarItem47.ImageOptions.LargeImage = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_SaveLarge;
		...
		this.lblReportText.Id = 55;
		this.lblReportText.Name = "lblReportText";
		this.lblReportText.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
		this.printPreviewRibbonPage1.ContextSpecifier = this.printRibbonController1;
		this.printPreviewRibbonPage1.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[7] { this.printPreviewRibbonPageGroup2, this.printPreviewRibbonPageGroup3, this.printPreviewRibbonPageGroup4, this.printPreviewRibbonPageGroup5, this.printPreviewRibbonPageGroup6, this.printPreviewRibbonPageGroup7, this.ribbonPageGroup1 });
		...
		this.printPreviewRibbonPageGroup2.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PrintDirect;
		this.printPreviewRibbonPageGroup2.ItemLinks.Add(this.printPreviewBarPrint);
		this.printPreviewRibbonPageGroup2.ItemLinks.Add(this.printPreviewBarQuickPrint);
		...
		this.printPreviewRibbonPageGroup2.Visible = false;
		this.printPreviewRibbonPageGroup3.ContextSpecifier = this.printRibbonController1;
		this.printPreviewRibbonPageGroup3.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PageMargins;
		...
		toolTipItem48.Appearance.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PageSetupDialog;
		toolTipItem48.Appearance.Options.UseImage = true;
		toolTipItem48.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_PageSetupDialog;
		...
		this.printPreviewRibbonPageGroup4.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Find;
		...
		this.printPreviewRibbonPageGroup5.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Zoom;
		...
		this.printPreviewRibbonPageGroup6.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_Watermark;
		this.printPreviewRibbonPageGroup6.ItemLinks.Add(this.printPreviewBarItem21);
		this.printPreviewRibbonPageGroup6.ItemLinks.Add(this.printPreviewWaterMark);
		...
		this.printPreviewRibbonPageGroup7.ImageOptions.Image = I_Xtreme.PrintRibbonControllerResources.RibbonPrintPreview_ExportFile;
		this.printPreviewRibbonPageGroup7.ItemLinks.Add(this.printPreviewBarExport);
		...
		this.printPreviewRibbonPageGroup7.Visible = false;
		this.ribbonPageGroup1.AllowTextClipping = false;
		this.ribbonPageGroup1.ItemLinks.Add(this.printPreviewBarItem25);
		this.ribbonPageGroup1.Name = "ribbonPageGroup1";
		this.ribbonPageGroup1.ShowCaptionButton = false;
		this.ribbonPageGroup1.Text = "Close";
		base.AutoScaleDimensions = new System.Drawing.SizeF(9f, 19f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.ClientSize = new System.Drawing.Size(1616, 740);
		...
		base.Name = "AcademicReport";
		this.Ribbon = this.ribbon;
		this.StatusBar = this.ribbonStatusBar;
		this.Text = "Academic Reports";
		base.KeyDown += new System.Windows.Forms.KeyEventHandler(AcademicReport_KeyDown);
