...
[XmlRoot("dSet_SchoolDetails_Small")]
[HelpKeyword("vs.data.DataSet")]
public class dSet_SchoolDetails_Small : DataSet
{
	...
	public class SchoolDetailsDataTable : TypedTableBase<SchoolDetailsRow>
	{
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
		public DataColumn ShortNameColumn => columnShortName;
		...
		[DebuggerNonUserCode]
		[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
		public SchoolDetailsRow AddSchoolDetailsRow(string SchoolName, string schoolMotto, string boxNumber, string location, string mobileContact, string officeContact, string emailAddress, string webAddress, string netAddress, string fullContact, byte[] logo, string district, string ShortName)
		{
			...
			object[] itemArray = new object[14]
			{
				...
				fullContact, logo, district, ShortName
			};
		...
		internal void InitVars()
		{
			...
			columnShortName = base.Columns["ShortName"];
		}
		...
		private void InitClass()
		{
			...
			columnShortName = new DataColumn("ShortName", typeof(string), null, MappingType.Element);
			base.Columns.Add(columnShortName);
		...
		public static XmlSchemaComplexType GetTypedTableSchema(XmlSchemaSet xs)
		{
			...
			dSet_SchoolDetails_Small dSet_SchoolDetails_Small2 = new dSet_SchoolDetails_Small();
			...
			xmlSchemaAttribute.FixedValue = dSet_SchoolDetails_Small2.Namespace;
			...
			XmlSchema schemaSerializable = dSet_SchoolDetails_Small2.GetSchemaSerializable();
	...
	public class SchoolDetailsRow : DataRow
	{
		...
		public string ShortName
		{
			get
			{
				try
				{
					return (string)base[tableSchoolDetails.ShortNameColumn];
				}
				catch (InvalidCastException innerException)
				{
					throw new StrongTypingException("The value for column 'ShortName' in table 'SchoolDetails' is DBNull.", innerException);
				}
			}
			set
			{
				base[tableSchoolDetails.ShortNameColumn] = value;
			}
		}
		...
		{
			return IsNull(tableSchoolDetails.ShortNameColumn);
		}
		...
		{
			base[tableSchoolDetails.ShortNameColumn] = Convert.DBNull;
		}
	}
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public dSet_SchoolDetails_Small()
	{
		BeginInit();
		InitClass();
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	protected dSet_SchoolDetails_Small(SerializationInfo info, StreamingContext context)
	...
	{
		dSet_SchoolDetails_Small dSet_SchoolDetails_Small2 = (dSet_SchoolDetails_Small)base.Clone();
		dSet_SchoolDetails_Small2.InitVars();
		dSet_SchoolDetails_Small2.SchemaSerializationMode = SchemaSerializationMode;
		return dSet_SchoolDetails_Small2;
	}
	...
	private void InitClass()
	{
		base.DataSetName = "dSet_SchoolDetails_Small";
		base.Prefix = "";
	...
	public static XmlSchemaComplexType GetTypedDataSetSchema(XmlSchemaSet xs)
	{
		...
		XmlSchemaSequence xmlSchemaSequence = new XmlSchemaSequence();
		XmlSchemaAny xmlSchemaAny = new XmlSchemaAny();
		xmlSchemaAny.Namespace = dSet_SchoolDetails_Small2.Namespace;
		xmlSchemaSequence.Items.Add(xmlSchemaAny);
		xmlSchemaComplexType.Particle = xmlSchemaSequence;
		XmlSchema schemaSerializable = dSet_SchoolDetails_Small2.GetSchemaSerializable();
		if (xs.Contains(schemaSerializable.TargetNamespace))
