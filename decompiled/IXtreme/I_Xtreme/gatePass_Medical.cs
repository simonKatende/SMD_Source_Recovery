...
public class gatePass_Medical : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		Detail.Controls.AddRange(new XRControl[20]
		{
			xrLabel27, xrLabel26, xrLabel25, xrLabel24, xrLabel23, xrLabel22, xrLabel21, xrLabel20, xrLabel19, xrLabel18,
			xrLabel17, xrLabel16, xrLabel15, xrLabel14, xrLabel13, xrLabel12, lblMessage, xrLabel10, xrLabel9, xrLabel8
		});
		...
		xrLabel15.LocationFloat = new PointFloat(7.999992f, 126f);
		...
		xrLabel14.LocationFloat = new PointFloat(432f, 94f);
		...
		xrLabel13.LocationFloat = new PointFloat(332f, 94f);
		...
		xrLabel12.LocationFloat = new PointFloat(8f, 94f);
		...
		lblMessage.LocationFloat = new PointFloat(7.999992f, 48.00002f);
		lblMessage.Name = "lblMessage";
		lblMessage.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		lblMessage.SizeF = new SizeF(650f, 37.99998f);
		lblMessage.StylePriority.UseFont = false;
		lblMessage.StylePriority.UseTextAlignment = false;
		lblMessage.Text = "We regret to inform you that your Daughter/Son has been sent back home on issues regarding his/her health conditions which are beyond the capability of the school. May he/she recover soon";
		...
		xrLabel8.LocationFloat = new PointFloat(93.99999f, 94f);
		...
		lblSex.LocationFloat = new PointFloat(592f, 140f);
		lblSex.Name = "lblSex";
		lblSex.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		lblSex.SizeF = new SizeF(66f, 22.99998f);
		lblSex.StylePriority.UseFont = false;
		lblSex.StylePriority.UseTextAlignment = false;
		lblSex.Text = "lblSex";
		lblSex.TextAlignment = TextAlignment.BottomCenter;
		...
		xrBarCode1.LocationFloat = new PointFloat(504f, 172f);
		...
		xrLabel6.SizeF = new SizeF(78f, 23.00003f);
		...
		lblClass.SizeF = new SizeF(89.99999f, 23.00003f);
		...
		PassNos2.Description = "PassNumber";
		PassNos2.Name = "PassNos2";
		PassNos2.Type = typeof(int);
		PassNos2.ValueInfo = "0";
		...
		xrLabel1.LocationFloat = new PointFloat(558f, 140f);
		...
		FilterString = "[passNo] = ?PassNos2";
		base.Margins = new DXMargins(20f, 20f, 20f, 20f);
		base.PageHeight = 540;
		base.PageWidth = 700;
		base.PaperKind = DXPaperKind.Custom;
		base.Parameters.AddRange(new Parameter[1] { PassNos2 });
