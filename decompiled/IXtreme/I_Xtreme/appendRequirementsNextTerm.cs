...
public class appendRequirementsNextTerm : XtraForm
{
	private int i;
	...
	public appendRequirementsNextTerm(string Item)
	{
		InitializeComponent();
		this.Item = Item;
	}
			...
			for (int i = 0; i < selectedRows.Length; i++)
			{
				...
				using (SqlConnection sqlConnection = new SqlConnection(DataConnection.ConnectToDatabase()))
				{
					...
					using SqlCommand sqlCommand = new SqlCommand
					{
						...
						CommandText = $"SELECT StudentNumber FROM FeesPaymentNextTerm WHERE StudentNumber='{text}' AND SemesterId='{StudentRequirements.Semester()}' AND Particulars='Fees'",
		...
		for (int j = 0; j < selectedRows2.Length; j++)
		{
			...
			using (SqlConnection sqlConnection3 = new SqlConnection(DataConnection.ConnectToDatabase()))
			{
				...
				using SqlCommand sqlCommand3 = new SqlCommand
				{
					...
					CommandText = $"SELECT StudentNumber FROM FeesPaymentNextTerm WHERE StudentNumber='{text3}' AND SemesterId='{StudentRequirements.Semester()}' AND Particulars='{StudentRequirements.RequiredItem()}'",
					CommandType = CommandType.Text
				};
				...
				if (!sqlDataReader2.HasRows)
				{
					...
					})
					{
						...
						sqlParameter2 = sqlCommand4.Parameters.Add("@DateOfPayment", SqlDbType.DateTime);
						sqlParameter2.Value = StudentRequirements.AppendDate.ToShortDateString();
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@SemesterId", SqlDbType.VarChar, 18);
						sqlParameter2.Value = StudentRequirements.Semester();
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@accNo", SqlDbType.VarChar, 9);
						sqlParameter2.Value = StudentRequirements.AccountNumber;
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@Particulars", SqlDbType.VarChar, 50);
						sqlParameter2.Value = StudentRequirements.RequiredItem();
						sqlParameter2.Direction = ParameterDirection.Input;
						...
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@Balance", SqlDbType.Money);
						sqlParameter2.Value = num4;
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@ModeOfPayment", SqlDbType.VarChar, 25);
						sqlParameter2.Value = string.Empty;
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@BankId", SqlDbType.VarChar, 50);
						sqlParameter2.Value = string.Empty;
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@BankSlipNo", SqlDbType.VarChar, 50);
						sqlParameter2.Value = string.Empty;
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@Narration", SqlDbType.VarChar, 50);
						sqlParameter2.Value = string.Empty;
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@CaptureDate", SqlDbType.VarChar, 100);
						sqlParameter2.Value = captureDate2;
						sqlParameter2.Direction = ParameterDirection.Input;
						sqlParameter2 = sqlCommand4.Parameters.Add("@IsSent", SqlDbType.Bit);
					...
					})
					{
						...
						sqlParameter3 = sqlCommand5.Parameters.Add("@cashOnAccount", SqlDbType.Money);
	...
	private void InitializeComponent()
	{
		...
		this.progressBarControl1.Size = new System.Drawing.Size(305, 36);
		this.progressBarControl1.TabIndex = 0;
		base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.ClientSize = new System.Drawing.Size(305, 36);
		base.ControlBox = false;
		base.Controls.Add(this.progressBarControl1);
		base.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
		base.IconOptions.ShowIcon = false;
		base.MaximizeBox = false;
		base.Name = "appendRequirementsNextTerm";
