...
public class TableAdapterManager : Component
{
	...
	private AttendanceSheetRollCallTableAdapter _attendanceSheetRollCallTableAdapter;
	...
	public AttendanceSheetRollCallTableAdapter AttendanceSheetRollCallTableAdapter
	{
		get
		{
			return _attendanceSheetRollCallTableAdapter;
		}
		set
		{
			_attendanceSheetRollCallTableAdapter = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_attendanceSheetRollCallTableAdapter != null && _attendanceSheetRollCallTableAdapter.Connection != null)
			{
				return _attendanceSheetRollCallTableAdapter.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_attendanceSheetRollCallTableAdapter != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(RollCallSource dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_attendanceSheetRollCallTableAdapter != null)
		{
			DataRow[] updatedRows = dataSet.AttendanceSheetRollCall.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _attendanceSheetRollCallTableAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(RollCallSource dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_attendanceSheetRollCallTableAdapter != null)
		{
			DataRow[] array = dataSet.AttendanceSheetRollCall.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _attendanceSheetRollCallTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(RollCallSource dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_attendanceSheetRollCallTableAdapter != null)
		{
			DataRow[] array = dataSet.AttendanceSheetRollCall.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _attendanceSheetRollCallTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(RollCallSource dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_attendanceSheetRollCallTableAdapter != null && !MatchTableAdapterConnection(_attendanceSheetRollCallTableAdapter.Connection))
		{
		...
		try
		{
			if (_attendanceSheetRollCallTableAdapter != null)
			{
				dictionary.Add(_attendanceSheetRollCallTableAdapter, _attendanceSheetRollCallTableAdapter.Connection);
				_attendanceSheetRollCallTableAdapter.Connection = (SqlConnection)connection;
				_attendanceSheetRollCallTableAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_attendanceSheetRollCallTableAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_attendanceSheetRollCallTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_attendanceSheetRollCallTableAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_attendanceSheetRollCallTableAdapter != null)
			{
				_attendanceSheetRollCallTableAdapter.Connection = (SqlConnection)dictionary[_attendanceSheetRollCallTableAdapter];
				_attendanceSheetRollCallTableAdapter.Transaction = null;
			}
			if (0 < list3.Count)
			{
