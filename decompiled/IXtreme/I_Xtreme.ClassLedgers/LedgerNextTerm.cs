...
using I_Xtreme.DataSets_Ledgers.FeesNextTermDSTableAdapters;

namespace I_Xtreme.ClassLedgers;

public class LedgerNextTerm : XtraReport
{
	...
	private FeesNextTermDS feesNextTermDS1;

	private adapterFeesNextTerm adapterFeesNextTerm;
	...
	public LedgerNextTerm()
	{
		InitializeComponent();
	}

	private void LedgerNextTerm_BeforePrint(object sender, CancelEventArgs e)
	{
	...
	private void InitializeComponent()
	{
		...
		feesNextTermDS1 = new FeesNextTermDS();
		adapterFeesNextTerm = new adapterFeesNextTerm();
		...
		((ISupportInitialize)feesNextTermDS1).BeginInit();
		...
		feesNextTermDS1.DataSetName = "FeesNextTermDS";
		feesNextTermDS1.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
		adapterFeesNextTerm.ClearBeforeFill = true;
		groupHeaderBand1.Controls.AddRange(new XRControl[16]
		{
			xrLabel11, xrLabel8, xrLabel28, xrLabel30, xrLine2, xrLine1, xrLabel26, xrLabel25, xrLabel24, xrLabel23,
			xrLabel22, xrLabel21, xrLabel9, xrLabel7, xrLabel12, xrLabel13
		});
		groupHeaderBand1.GroupFields.AddRange(new GroupField[1]
		{
			new GroupField("auto", XRColumnSortOrder.Ascending)
		});
		groupHeaderBand1.HeightF = 126f;
		groupHeaderBand1.Name = "groupHeaderBand1";
		groupHeaderBand1.PageBreak = PageBreak.BeforeBand;
		xrLabel11.Borders = BorderSide.Bottom;
		xrLabel11.Font = new DXFont("Tahoma", 11f);
		xrLabel11.LocationFloat = new PointFloat(0f, 2f);
		...
		xrLabel8.LocationFloat = new PointFloat(92.00001f, 66f);
		...
		xrLabel28.LocationFloat = new PointFloat(87.41655f, 100f);
		...
		xrLabel30.LocationFloat = new PointFloat(262f, 2f);
		...
		xrLabel30.Text = "FEES NEXT TERM";
		xrLabel30.TextAlignment = TextAlignment.BottomCenter;
		xrLine2.LocationFloat = new PointFloat(0f, 98f);
		xrLine2.Name = "xrLine2";
		xrLine2.SizeF = new SizeF(667f, 2f);
		xrLine1.LocationFloat = new PointFloat(0f, 124f);
		...
		xrLabel26.LocationFloat = new PointFloat(566.9999f, 100f);
		...
		xrLabel25.LocationFloat = new PointFloat(466.9999f, 100f);
		...
		xrLabel24.LocationFloat = new PointFloat(366.9999f, 100f);
		...
		xrLabel23.LocationFloat = new PointFloat(248.4685f, 100f);
		...
		xrLabel22.LocationFloat = new PointFloat(0f, 100f);
		...
		xrLabel21.LocationFloat = new PointFloat(162f, 100f);
		...
		xrLabel9.LocationFloat = new PointFloat(92.00001f, 41.99999f);
		...
		xrLabel7.LocationFloat = new PointFloat(405.9999f, 2f);
		...
		xrLabel12.LocationFloat = new PointFloat(4f, 42f);
		...
		xrLabel13.LocationFloat = new PointFloat(4f, 66f);
		...
		base.Bands.AddRange(new Band[5] { Detail, pageFooterBand1, topMarginBand1, bottomMarginBand1, groupHeaderBand1 });
		base.ComponentStorage.AddRange(new IComponent[1] { feesNextTermDS1 });
		base.DataAdapter = adapterFeesNextTerm;
		base.DataMember = "dtFeesNextTerm";
		base.DataSource = feesNextTermDS1;
		...
		base.Version = "22.2";
		BeforePrint += LedgerNextTerm_BeforePrint;
		((ISupportInitialize)feesNextTermDS1).EndInit();
