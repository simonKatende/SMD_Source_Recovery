...
public class SummaryPerSubjectSub : XtraReport
{
	...
	public SummaryPerSubjectSub(string ClassEn, string StreamEn, string Term)
	{
		InitializeComponent();
		base.DataSource = GradeSummaryService.GetAlevelGradeSummaryPerSubjectSub(ClassEn, StreamEn, Term);
	}
	...
	private void InitializeComponent()
	{
		...
		xrTableRow2.Cells.AddRange(new XRTableCell[8] { xrTableCell12, xrTableCell14, xrTableCell15, xrTableCell16, xrTableCell17, xrTableCell18, xrTableCell19, xrTableCell22 });
		...
		xrTableRow1.Cells.AddRange(new XRTableCell[8] { xrTableCell1, xrTableCell3, xrTableCell4, xrTableCell5, xrTableCell6, xrTableCell7, xrTableCell8, xrTableCell11 });
		...
		xrLabel1.Text = "Count of grades per subject";
