...
public class SummaryPerPaper : XtraReport
{
	...
	public SummaryPerPaper(string ClassEn, string StreamEn, string Term)
	{
		InitializeComponent();
		base.DataSource = GradeSummaryService.GetAlevelGradeSummaryPerPaper(ClassEn, StreamEn, Term);
	}
	...
	private void InitializeComponent()
	{
		...
		xrLabel1.Text = "Count of grades per paper";
