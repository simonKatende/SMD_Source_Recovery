...
public class SummaryPerSubject : XtraReport
{
	...
	public SummaryPerSubject(string ClassEn, string StreamEn, string Term)
	{
		InitializeComponent();
		base.DataSource = GradeSummaryService.GetAlevelGradeSummaryPerSubject(ClassEn, StreamEn, Term);
	}
