...
namespace I_Xtreme.DataSets_Ledgers.FeesNextTermDSTableAdapters;
...
public class adapterFeesNextTerm : Component
{
	...
	private void InitAdapter()
	{
		...
		dataTableMapping.DataSetTable = "dtFeesNextTerm";
	...
	private void InitCommandCollection()
	{
		...
		_commandCollection[0].CommandText = $"SELECT        s.fullName, s.StudentNumber, s.StudentID, f.PaymentId, f.DateOfPayment, f.BankSlipNo, f.SemesterId, f.Debit, f.Credit, f.Balance, s.auto, s.ClassId, f.Particulars\r\nFROM            FeesPaymentNextTerm AS f INNER JOIN\r\n                         tbl_Stud AS s ON f.StudentNumber = s.StudentNumber\r\nWHERE        (s.ClassId = '{ReportParameters.Class}')\r\nORDER BY f.PaymentId";
	...
	public virtual int Fill(FeesNextTermDS.dtFeesNextTermDataTable dataTable)
	{
	...
	public virtual FeesNextTermDS.dtFeesNextTermDataTable GetData()
	{
		Adapter.SelectCommand = CommandCollection[0];
		FeesNextTermDS.dtFeesNextTermDataTable dtFeesNextTermDataTable = new FeesNextTermDS.dtFeesNextTermDataTable();
		Adapter.Fill(dtFeesNextTermDataTable);
