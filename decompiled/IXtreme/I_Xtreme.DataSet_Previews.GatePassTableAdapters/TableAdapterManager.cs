...
public class TableAdapterManager : Component
{
	...
	private tbl_GatePassTableAdapter _tbl_GatePassTableAdapter;
	...
	public tbl_GatePassTableAdapter tbl_GatePassTableAdapter
	{
		get
		{
			return _tbl_GatePassTableAdapter;
		}
		set
		{
			_tbl_GatePassTableAdapter = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_tbl_GatePassTableAdapter != null && _tbl_GatePassTableAdapter.Connection != null)
			{
				return _tbl_GatePassTableAdapter.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_tbl_GatePassTableAdapter != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(GatePass dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_tbl_GatePassTableAdapter != null)
		{
			DataRow[] updatedRows = dataSet.tbl_GatePass.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _tbl_GatePassTableAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(GatePass dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_tbl_GatePassTableAdapter != null)
		{
			DataRow[] array = dataSet.tbl_GatePass.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _tbl_GatePassTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(GatePass dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_tbl_GatePassTableAdapter != null)
		{
			DataRow[] array = dataSet.tbl_GatePass.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _tbl_GatePassTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(GatePass dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_tbl_GatePassTableAdapter != null && !MatchTableAdapterConnection(_tbl_GatePassTableAdapter.Connection))
		{
		...
		try
		{
			if (_tbl_GatePassTableAdapter != null)
			{
				dictionary.Add(_tbl_GatePassTableAdapter, _tbl_GatePassTableAdapter.Connection);
				_tbl_GatePassTableAdapter.Connection = (SqlConnection)connection;
				_tbl_GatePassTableAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_tbl_GatePassTableAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_tbl_GatePassTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_tbl_GatePassTableAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_tbl_GatePassTableAdapter != null)
			{
				_tbl_GatePassTableAdapter.Connection = (SqlConnection)dictionary[_tbl_GatePassTableAdapter];
				_tbl_GatePassTableAdapter.Transaction = null;
			}
			if (0 < list3.Count)
			{
