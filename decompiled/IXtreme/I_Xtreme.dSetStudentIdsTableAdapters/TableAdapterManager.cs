...
public class TableAdapterManager : Component
{
	...
	public studentsTableAdapter studentsTableAdapter
	{
		get
		{
			return _studentsTableAdapter;
		}
		set
		{
			_studentsTableAdapter = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_studentsTableAdapter != null && _studentsTableAdapter.Connection != null)
			{
				return _studentsTableAdapter.Connection;
			}
			return null;
		}
		set
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(dSetStudentIds dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_studentsTableAdapter != null)
		{
			DataRow[] updatedRows = dataSet.students.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _studentsTableAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(dSetStudentIds dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_studentsTableAdapter != null)
		{
			DataRow[] array = dataSet.students.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _studentsTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(dSetStudentIds dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_studentsTableAdapter != null)
		{
			DataRow[] array = dataSet.students.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _studentsTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(dSetStudentIds dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_studentsTableAdapter != null && !MatchTableAdapterConnection(_studentsTableAdapter.Connection))
		{
		...
		try
		{
			if (_studentsTableAdapter != null)
			{
				dictionary.Add(_studentsTableAdapter, _studentsTableAdapter.Connection);
				_studentsTableAdapter.Connection = (SqlConnection)connection;
				_studentsTableAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_studentsTableAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_studentsTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_studentsTableAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_studentsTableAdapter != null)
			{
				_studentsTableAdapter.Connection = (SqlConnection)dictionary[_studentsTableAdapter];
				_studentsTableAdapter.Transaction = null;
			}
			if (0 < list3.Count)
			{
