...
public class ALevelSub : XtraReport
{
	...
	public ALevelSub()
	{
		...
		lblComment2.Text = ReportCustomization.Comment2Label;
	...
	private void InitializeComponent()
	{
		...
		lblComment2 = new XRLabel();
		xrLabel2 = new XRLabel();
		xrLabel3 = new XRLabel();
		xrShape7 = new XRShape();
		xrShape8 = new XRShape();
		...
		xrTableCell22.BackColor = Color.Transparent;
		...
		xrTableCell27.BackColor = Color.Transparent;
		...
		xrTableCell30.BackColor = Color.Transparent;
		...
		xrTableCell35.BackColor = Color.Transparent;
		...
		xrTableCell47.BackColor = Color.Transparent;
		...
		xrTableCell49.BackColor = Color.Transparent;
		...
		xrTableCell51.BackColor = Color.Transparent;
		...
		xrTableCell53.BackColor = Color.Transparent;
		...
		hTTL.BackColor = Color.Transparent;
		hTTL.Name = "hTTL";
		...
		xrTableCell60.BackColor = Color.Transparent;
		...
		xrTableCell62.BackColor = Color.Transparent;
		...
		xrLabel6.LocationFloat = new PointFloat(10.5f, 28f);
		xrLabel6.Name = "xrLabel6";
		xrLabel6.Padding = new PaddingInfo(5, 2, 0, 0, 100f);
		xrLabel6.SizeF = new SizeF(603f, 23f);
		...
		lblComment1.Font = new DXFont("Cascadia Mono", 11f);
		lblComment1.ForeColor = Color.Black;
		lblComment1.LocationFloat = new PointFloat(10.5f, 4.5f);
		lblComment1.Name = "lblComment1";
		lblComment1.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		lblComment1.SizeF = new SizeF(451.0417f, 23f);
		...
		lblComment1.Text = "Comment1:";
		lblComment1.TextAlignment = TextAlignment.MiddleLeft;
		lblComment1.WordWrap = false;
		xrShape1.LocationFloat = new PointFloat(1.5f, 0f);
		xrShape1.Name = "xrShape1";
		xrShape1.Shape = shape2;
		xrShape1.SizeF = new SizeF(774.9998f, 64f);
		footerComment2.Controls.AddRange(new XRControl[5] { lblComment2, xrLabel2, xrLabel3, xrShape7, xrShape8 });
		footerComment2.HeightF = 70.50002f;
		footerComment2.Level = 4;
		footerComment2.Name = "footerComment2";
		footerComment2.PrintAtBottom = true;
		lblComment2.BackColor = Color.Transparent;
		lblComment2.BorderColor = Color.Black;
		lblComment2.BorderDashStyle = BorderDashStyle.Dash;
		lblComment2.Borders = BorderSide.None;
		lblComment2.CanGrow = false;
		lblComment2.Font = new DXFont("Cascadia Mono", 11f);
		lblComment2.ForeColor = Color.Black;
		lblComment2.LocationFloat = new PointFloat(10.5f, 4.5f);
		lblComment2.Name = "lblComment2";
		lblComment2.Padding = new PaddingInfo(2, 2, 0, 0, 100f);
		lblComment2.SizeF = new SizeF(451.0417f, 23f);
		lblComment2.StylePriority.UseBackColor = false;
		lblComment2.StylePriority.UseBorderColor = false;
		lblComment2.StylePriority.UseBorderDashStyle = false;
		lblComment2.StylePriority.UseBorders = false;
		lblComment2.StylePriority.UseFont = false;
		lblComment2.StylePriority.UseForeColor = false;
		lblComment2.StylePriority.UseTextAlignment = false;
		lblComment2.Text = "Comment2:";
		lblComment2.TextAlignment = TextAlignment.MiddleLeft;
		lblComment2.WordWrap = false;
		xrLabel2.BorderColor = Color.Black;
		xrLabel2.BorderDashStyle = BorderDashStyle.Solid;
		...
		xrLabel2.ForeColor = Color.Black;
		xrLabel2.LocationFloat = new PointFloat(10.5f, 28f);
		xrLabel2.Name = "xrLabel2";
		xrLabel2.Padding = new PaddingInfo(5, 2, 0, 0, 100f);
		xrLabel2.SizeF = new SizeF(603f, 23f);
		...
		xrLabel3.Font = new DXFont("Cascadia Mono", 10f);
		xrLabel3.LocationFloat = new PointFloat(624.5f, 3.5f);
		...
		xrLabel3.Text = "Signature";
		xrLabel3.TextAlignment = TextAlignment.MiddleLeft;
		xrShape7.LocationFloat = new PointFloat(619.5f, 0f);
		xrShape7.Name = "xrShape7";
		xrShape7.Shape = shape3;
		xrShape7.SizeF = new SizeF(2f, 64f);
		xrShape8.LocationFloat = new PointFloat(1.5f, 0f);
		xrShape8.Name = "xrShape8";
		xrShape8.Shape = shape4;
		xrShape8.SizeF = new SizeF(774.9998f, 64f);
		...
		term.Name = "term";
		term.Visible = false;
		base.Bands.AddRange(new Band[9] { Detail, topMarginBand1, bottomMarginBand1, footerTotalPoints, footerComment1, footerComment2, footerPromotion, footerCommentHeader, headerGroup });
