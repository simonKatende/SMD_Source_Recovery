...
using I_Xtreme.AdvancedReports.StorageSub.PrimaryASubDSTableAdapters;

namespace I_Xtreme.AdvancedReports.ReportsSub;

public class PrimaryA : XtraReport
{
	...
	private PrimaryASubDS primaryASubDS1;

	private adapterPrimaryASubDS adapterPrimaryASubDS1;
	...
	private void InitializeComponent()
	{
		...
		primaryASubDS1 = new PrimaryASubDS();
		adapterPrimaryASubDS1 = new adapterPrimaryASubDS();
		GroupHeader1 = new GroupHeaderBand();
		((ISupportInitialize)xrTable1).BeginInit();
		((ISupportInitialize)xrTable2).BeginInit();
		((ISupportInitialize)primaryASubDS1).BeginInit();
		...
		xrTableRow1.Cells.AddRange(new XRTableCell[9] { xrTableCell1, vHOP, vBOT, vMOT, vEOT, xrTableCell12, xrTableCell8, xrTableCell5, xrTableCell6 });
		xrTableRow1.Name = "xrTableRow1";
		xrTableRow1.Weight = 1.0;
		xrTableCell1.BackColor = Color.WhiteSmoke;
		...
		xrTableCell1.Weight = 0.964774643358816;
		...
		xrTableCell12.Weight = 0.256082152011811;
		xrTableCell8.BackColor = Color.WhiteSmoke;
		...
		xrTableCell8.Weight = 0.256082160177543;
		...
		xrTableCell5.Font = new DXFont("Comic Sans MS", 8.5f);
		xrTableCell5.ForeColor = Color.Blue;
		xrTableCell5.Name = "xrTableCell5";
		xrTableCell5.Padding = new PaddingInfo(3, 0, 0, 0, 100f);
		...
		xrTableCell5.Weight = 1.78661979208549;
		xrTableCell6.BackColor = Color.WhiteSmoke;
		...
		xrTableCell6.Weight = 0.357323826176195;
		...
		xrLabel1.Text = "Principal Subjects Comprising the General Assessment";
		...
		xrTable2.SizeF = new SizeF(780f, 50f);
		...
		xrTableRow3.Cells.AddRange(new XRTableCell[9] { xrTableCell19, hHOP, hBOT, hMOT, hEOT, xrTableCell9, xrTableCell23, xrTableCell14, xrTableCell15 });
		xrTableRow3.Name = "xrTableRow3";
		xrTableRow3.Weight = 1.0;
		xrTableCell19.BackColor = Color.WhiteSmoke;
		xrTableCell19.BorderColor = Color.Black;
		xrTableCell19.Font = new DXFont("Tahoma", 10f, DXFontStyle.Bold);
		xrTableCell19.Name = "xrTableCell19";
		xrTableCell19.StylePriority.UseBackColor = false;
		xrTableCell19.StylePriority.UseBorderColor = false;
		xrTableCell19.StylePriority.UseFont = false;
		xrTableCell19.StylePriority.UseTextAlignment = false;
		xrTableCell19.Text = "SUBJECT";
		xrTableCell19.TextAlignment = TextAlignment.MiddleCenter;
		xrTableCell19.Weight = 0.463732713417547;
		hHOP.BackColor = Color.Transparent;
		hHOP.BorderColor = Color.Black;
		hHOP.Font = new DXFont("Tahoma", 10f, DXFontStyle.Bold);
		hHOP.Name = "hHOP";
		hHOP.StylePriority.UseBackColor = false;
		hHOP.StylePriority.UseBorderColor = false;
		hHOP.StylePriority.UseFont = false;
		hHOP.Text = "HoP";
		hHOP.Weight = 0.123089546185932;
		hBOT.BackColor = Color.Transparent;
		hBOT.BorderColor = Color.Black;
		hBOT.Font = new DXFont("Tahoma", 10f, DXFontStyle.Bold);
		hBOT.Name = "hBOT";
		hBOT.StylePriority.UseBackColor = false;
		hBOT.StylePriority.UseBorderColor = false;
		hBOT.StylePriority.UseFont = false;
		hBOT.StylePriority.UseForeColor = false;
		hBOT.Text = "BOT";
		hBOT.Weight = 0.123089546185932;
		hMOT.BackColor = Color.Transparent;
		hMOT.BorderColor = Color.Black;
		hMOT.Font = new DXFont("Tahoma", 10f, DXFontStyle.Bold);
		hMOT.Name = "hMOT";
		hMOT.StylePriority.UseBackColor = false;
		hMOT.StylePriority.UseBorderColor = false;
		hMOT.StylePriority.UseFont = false;
		hMOT.Text = "MOT";
		hMOT.Weight = 0.123089545339146;
		hEOT.BackColor = Color.Transparent;
		hEOT.BorderColor = Color.Black;
		hEOT.Font = new DXFont("Tahoma", 10f, DXFontStyle.Bold);
		hEOT.Name = "hEOT";
		hEOT.StylePriority.UseBackColor = false;
		hEOT.StylePriority.UseBorderColor = false;
		hEOT.StylePriority.UseFont = false;
		hEOT.Text = "EOT";
		hEOT.Weight = 0.123089550092607;
		xrTableCell9.BackColor = Color.Transparent;
		xrTableCell9.BorderColor = Color.Black;
		xrTableCell9.Font = new DXFont("Tahoma", 7.4f, DXFontStyle.Bold);
		...
		xrTableCell9.Text = "SCORE";
		xrTableCell9.Weight = 0.123089550092607;
		xrTableCell23.BackColor = Color.WhiteSmoke;
		xrTableCell23.BorderColor = Color.Black;
		xrTableCell23.Font = new DXFont("Tahoma", 7.4f, DXFontStyle.Bold);
		xrTableCell23.ForeColor = Color.Maroon;
		...
		xrTableCell23.Text = "GRADE";
		xrTableCell23.Weight = 0.123089552148038;
		xrTableCell14.BackColor = Color.Transparent;
		xrTableCell14.BorderColor = Color.Black;
		...
		xrTableCell14.Text = "COMMENT";
		xrTableCell14.Weight = 0.858764267564193;
		xrTableCell15.BackColor = Color.WhiteSmoke;
		xrTableCell15.BorderColor = Color.Black;
		xrTableCell15.Font = new DXFont("Tahoma", 8f, DXFontStyle.Bold);
		xrTableCell15.Name = "xrTableCell15";
		xrTableCell15.StylePriority.UseBackColor = false;
		xrTableCell15.StylePriority.UseBorderColor = false;
		xrTableCell15.StylePriority.UseFont = false;
		xrTableCell15.Text = "INITIALS";
		xrTableCell15.Weight = 0.171752879415809;
		xrTableRow2.Cells.AddRange(new XRTableCell[9] { xrTableCell20, rHoP, rBOT, rMOT, rEOT, hTTL, xrTableCell24, xrTableCell11, xrTableCell16 });
		xrTableRow2.Name = "xrTableRow2";
		xrTableRow2.Weight = 1.0;
		xrTableCell20.BackColor = Color.WhiteSmoke;
		...
		primaryASubDS1.DataSetName = "PrimaryASubDS";
		primaryASubDS1.EnforceConstraints = false;
		primaryASubDS1.SchemaSerializationMode = SchemaSerializationMode.IncludeSchema;
		adapterPrimaryASubDS1.ClearBeforeFill = true;
		...
		base.ComponentStorage.AddRange(new IComponent[1] { primaryASubDS1 });
		base.DataAdapter = adapterPrimaryASubDS1;
		base.DataMember = "PrimaryASubDS";
		base.DataSource = primaryASubDS1;
		...
		((ISupportInitialize)primaryASubDS1).EndInit();
