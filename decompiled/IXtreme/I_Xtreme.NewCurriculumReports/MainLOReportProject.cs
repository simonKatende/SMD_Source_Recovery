...
public class MainLOReportProject : XtraReport
{
	...
	public MainLOReportProject(bool showUnAssessed)
	{
		InitializeComponent();
	...
	private void InitializeComponent()
	{
		...
		xrSubreport2.ReportSource = new LOReportProject();
		...
		xrPictureBox1.LocationFloat = new PointFloat(664.5f, 47.5f);
		...
		GroupFooter2.Controls.AddRange(new XRControl[5] { xrBarCode2, tblTermBegins, tblFeesInfo, xrLabel1, lblOtherRequirements });
		...
		xrBarCode2.LocationFloat = new PointFloat(655.0418f, 0f);
		...
		tblTermBegins.LocationFloat = new PointFloat(3.041681f, 0f);
		...
		tblFeesInfo.LocationFloat = new PointFloat(324.2717f, 0f);
		tblFeesInfo.Name = "tblFeesInfo";
		tblFeesInfo.Rows.AddRange(new XRTableRow[2] { xrTableRow10, xrTableRow1 });
		...
		xrTableRow1.Cells.AddRange(new XRTableCell[2] { lblFeesBalance, lblFeesNextTerm });
		...
		xrLabel1.LocationFloat = new PointFloat(4.083347f, 57.5f);
		...
		lblOtherRequirements.LocationFloat = new PointFloat(187.4584f, 57.5f);
