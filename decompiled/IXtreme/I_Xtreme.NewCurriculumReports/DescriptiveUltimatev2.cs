...
public class DescriptiveUltimatev2 : XtraReport
{
	...
	{
		ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(DescriptiveUltimatev2));
		...
		xrSubreport2.ReportSource = new DescriptiveUltimateReportSubv2();
		...
		footerLearningOutcomeScale.HeightF = 293.8138f;
		footerLearningOutcomeScale.Name = "footerLearningOutcomeScale";
		footerLearningOutcomeScale.SubBands.AddRange(new SubBand[3] { SubBand1, SubBand2, SubBand3 });
		...
		SubBand1.Controls.AddRange(new XRControl[1] { xrTable1 });
		SubBand1.HeightF = 65f;
		SubBand1.Name = "SubBand1";
		xrTable1.Borders = BorderSide.All;
		xrTable1.Font = new DXFont("Tahoma", 9.75f, DXFontStyle.Regular, DXGraphicsUnit.Point, new DXFontAdditionalProperty[1]
		{
		...
		xrTable1.Rows.AddRange(new XRTableRow[2] { xrTableRow20, xrTableRow21 });
		xrTable1.SizeF = new SizeF(778.9999f, 40.00001f);
		...
		xrTableRow20.Cells.AddRange(new XRTableCell[5] { xrTableCell8, xrTableCell25, xrTableCell26, xrTableCell27, xrTableCell15 });
		xrTableRow20.Name = "xrTableRow20";
		xrTableRow20.Weight = 1.0;
		xrTableCell8.Font = new DXFont("Tahoma", 9.75f, DXFontStyle.Bold, DXGraphicsUnit.Point, new DXFontAdditionalProperty[1]
		{
			new DXFontAdditionalProperty("GdiCharSet", (byte)0)
		});
		...
		xrTableCell15.Font = new DXFont("Tahoma", 9.75f, DXFontStyle.Bold, DXGraphicsUnit.Point, new DXFontAdditionalProperty[1]
		{
			new DXFontAdditionalProperty("GdiCharSet", (byte)0)
		});
