...
public class UltimateReport : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		xrSubreport2.ParameterBindings.Add(new ParameterBinding("OtherFeesRequirements", null, "StudentsDS.StudentNumber"));
		xrSubreport2.ReportSource = new UltimateReportSub();
		...
		tblFeesInfo.LocationFloat = new PointFloat(321.2276f, 0f);
		...
		xrTableRow1.Cells.AddRange(new XRTableCell[2] { xrTableCell5, xrTableCell6 });
		...
		xrTableCell5.Text = "Fees Balance";
		xrTableCell5.TextAlignment = TextAlignment.MiddleCenter;
		xrTableCell5.Weight = 0.37753038223003454;
		xrTableCell6.BackColor = Color.Black;
		xrTableCell6.BorderDashStyle = BorderDashStyle.Solid;
		xrTableCell6.Borders = BorderSide.All;
		xrTableCell6.Font = new DXFont("Cascadia Code", 9.75f, DXFontStyle.Bold);
		...
		xrTableCell6.StylePriority.UseBorderDashStyle = false;
		...
		xrTableCell6.Text = "Fees Next Term";
		xrTableCell6.TextAlignment = TextAlignment.MiddleCenter;
		xrTableCell6.Weight = 0.3775304025255647;
		xrTableRow11.Cells.AddRange(new XRTableCell[2] { lblFeesBalance, lblFeesNextTerm });
		...
		footerKeysUsed.Controls.AddRange(new XRControl[2] { xrTable7, xrTable6 });
		...
		xrTable6.LocationFloat = new PointFloat(321.2276f, 0f);
		...
		xrLabel1.LocationFloat = new PointFloat(0f, 57.83335f);
		...
		lblOtherRequirements.LocationFloat = new PointFloat(183.375f, 57.83335f);
