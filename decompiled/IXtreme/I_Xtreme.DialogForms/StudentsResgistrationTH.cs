...
public class StudentsResgistrationTH : XtraForm
{
	...
	public StudentsResgistrationTH()
	{
		InitializeComponent();
	...
	private void cboClass_EditValueChanged(object sender, EventArgs e)
	{
		if (cboClass.EditValue != null)
		{
			...
			{
				AlienAge.ArabicTheology.TheologyHelperClasses.Subjects.LoadSubjectsToGridEn(gridControl2, Classes.ClassLevels.Shuuba.ToString());
			}
			else if (cboClass.SelectedItem.ToString().Contains("Idaad"))
			{
				AlienAge.ArabicTheology.TheologyHelperClasses.Subjects.LoadSubjectsToGridEn(gridControl2, Classes.ClassLevels.Idaad.ToString());
			}
			else if (cboClass.SelectedItem.ToString().Contains("Thanawi"))
			{
				AlienAge.ArabicTheology.TheologyHelperClasses.Subjects.LoadSubjectsToGridEn(gridControl2, Classes.ClassLevels.Thanawi.ToString());
			}
			SqlDataAdapter sqlDataAdapter = new SqlDataAdapter($"SELECT * FROM tbl_Stud WHERE ClassIdEn='{cboClass.Text}' AND IsTheologyStud=1", DataConnection.ConnectToDatabase());
	...
	private void simpleButton2_Click(object sender, EventArgs e)
	{
		while (dxValidationProvider1.Validate())
		{
			...
			if (gridView1.SelectedRowsCount > 0)
			{
				...
				{
					RegisterStudentsNewCurTH registerStudentsNewCurTH = new RegisterStudentsNewCurTH(cboClass.EditValue.ToString(), cboTerm.EditValue.ToString(), gridView2, gridView1);
					if (registerStudentsNewCurTH.ShowDialog() != DialogResult.OK)
					{
					}
				}
				else
	...
	private void InitializeComponent()
	{
		...
		this.gridControl2.Location = new System.Drawing.Point(7, 105);
		this.gridControl2.MainView = this.gridView2;
		this.gridControl2.Margin = new System.Windows.Forms.Padding(2);
		this.gridControl2.Name = "gridControl2";
		this.gridControl2.Size = new System.Drawing.Size(166, 249);
		...
		this.gridView2.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[2] { this.gridColumn6, this.gridColumn7 });
		...
		this.gridColumn6.FieldName = "Subject_En";
		this.gridColumn6.Name = "gridColumn6";
		this.gridColumn6.Visible = true;
		this.gridColumn6.VisibleIndex = 1;
		this.gridColumn7.Caption = "SubjectAr";
		this.gridColumn7.FieldName = "Subject_Ar";
		this.gridColumn7.Name = "gridColumn7";
		this.dxValidationProvider1.SetIconAlignment(this.cboClass, System.Windows.Forms.ErrorIconAlignment.MiddleRight);
		this.cboClass.Location = new System.Drawing.Point(44, 28);
		...
		this.dxValidationProvider1.SetValidationRule(this.cboClass, conditionValidationRule);
		...
		this.cboTerm.Location = new System.Drawing.Point(44, 52);
		...
		this.cboTerm.Size = new System.Drawing.Size(129, 20);
		...
		this.layoutControlGroup1.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[2] { this.layoutControlItem5, this.layoutControlItem4 });
		this.layoutControlGroup1.Location = new System.Drawing.Point(0, 0);
		this.layoutControlGroup1.Name = "layoutControlGroup1";
		this.layoutControlGroup1.Padding = new DevExpress.XtraLayout.Utils.Padding(1, 1, 1, 1);
		this.layoutControlGroup1.Size = new System.Drawing.Size(178, 77);
		...
		this.layoutControlGroup2.Size = new System.Drawing.Size(178, 282);
		this.layoutControlGroup2.Text = "SUBJECTS";
		this.layoutControlItem2.Control = this.gridControl2;
		this.layoutControlItem2.Location = new System.Drawing.Point(0, 0);
		this.layoutControlItem2.Name = "layoutControlItem2";
		this.layoutControlItem2.Size = new System.Drawing.Size(170, 253);
		...
		base.Name = "StudentsResgistrationTH";
