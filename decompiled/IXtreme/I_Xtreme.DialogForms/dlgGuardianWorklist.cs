...
public class dlgGuardianWorklist : XtraForm
{
    ...
    {
        this.Text          = "Guardian Worklist — All Guardians with Outstanding Fees";
    ...
    private void LoadData()
    {
        try
        {
            ...
            _allRows = _service.GetGuardianWorklist(classFilter, minBal);
    ...
    private void View_DoubleClick(object sender, EventArgs e)
    {
        ...
        dlg.ShowDialog(this);
        LoadData();   // refresh after interaction
    }
