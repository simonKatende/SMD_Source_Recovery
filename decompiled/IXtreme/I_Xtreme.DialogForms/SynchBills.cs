...
public class SynchBills : XtraForm
{
	private int k = 0;
	...
	private void PostData()
	{
		try
		{
			...
			string cmdText = " SELECT Debit, PaymentId, Particulars, SemesterId, StudentNumber FROM FeesPayment WHERE IsSynched = 0 AND Debit > 0 AND StudentNumber LIKE @schoolRef + '%' ORDER BY PaymentId";
			string cmdText2 = "SELECT COUNT(PaymentId) FROM FeesPayment WHERE IsSynched = 0 AND Debit > 0  AND StudentNumber LIKE @schoolRef + '%'";
			using SqlConnection sqlConnection = new SqlConnection(connString);
			sqlConnection.Open();
			using (SqlCommand sqlCommand = new SqlCommand(cmdText2, sqlConnection))
			{
				sqlCommand.Parameters.AddWithValue("@schoolRef", schoolCode);
				maximum = (int)sqlCommand.ExecuteScalar();
			}
			k = 1;
			List<long> list = new List<long>();
			using (SqlCommand sqlCommand2 = new SqlCommand(cmdText, sqlConnection))
			{
				sqlCommand2.Parameters.AddWithValue("@schoolRef", schoolCode);
				using SqlDataReader sqlDataReader = sqlCommand2.ExecuteReader();
				while (sqlDataReader.Read())
				{
					string studentNo = sqlDataReader["StudentNumber"].ToString();
					if (DataSyncHelper.StudentExists(studentNo) == "OK")
					{
						double amount = Convert.ToDouble(sqlDataReader["Debit"]);
						long item = Convert.ToInt64(sqlDataReader["PaymentId"]);
						string particulars = sqlDataReader["Particulars"].ToString();
						string term = sqlDataReader["SemesterId"].ToString();
						string value = JsonConvert.SerializeObject(new
						{
							amount = amount,
							studentNo = studentNo,
							term = term,
							schoolRef = schoolCode,
							awardDiscount = false,
							particulars = particulars
						});
						string requestUriString = DataSyncHelper.UrlString + "/api/feespayment/appendfromoffline";
			...
			if (list.Count > 0)
			{
				string cmdText3 = "\r\n                    UPDATE FeesPayment \r\n                    SET IsSynched = 1 \r\n                    WHERE PaymentId IN (" + string.Join(",", list) + ")";
	...
	private void InitializeComponent()
	{
		...
		this.simpleButton1.Location = new System.Drawing.Point(191, 92);
		...
		this.layoutControl1.Size = new System.Drawing.Size(379, 116);
		this.layoutControl1.TabIndex = 7;
		this.layoutControl1.Text = "layoutControl1";
		this.simpleButton2.Appearance.Font = new System.Drawing.Font("Tahoma", 10f);
		this.simpleButton2.Appearance.Options.UseFont = true;
		this.simpleButton2.Location = new System.Drawing.Point(2, 92);
		...
		this.progressBarControl1.Size = new System.Drawing.Size(375, 50);
		...
		this.Root.Size = new System.Drawing.Size(379, 116);
		...
		this.layoutControlItem1.Size = new System.Drawing.Size(379, 54);
		this.layoutControlItem1.SizeConstraintsType = DevExpress.XtraLayout.SizeConstraintsType.Custom;
		this.layoutControlItem1.TextSize = new System.Drawing.Size(0, 0);
		this.layoutControlItem1.TextVisible = false;
		this.layoutControlItem3.Control = this.simpleButton1;
		this.layoutControlItem3.Location = new System.Drawing.Point(189, 90);
		...
		this.emptySpaceItem1.Size = new System.Drawing.Size(379, 36);
		...
		base.ClientSize = new System.Drawing.Size(379, 116);
		base.Controls.Add(this.layoutControl1);
		base.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
		base.MaximizeBox = false;
		base.MinimizeBox = false;
		base.Name = "SynchBills";
		base.ShowInTaskbar = false;
		base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "Sync Bills";
