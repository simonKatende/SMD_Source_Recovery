...
public class TableAdapterManager : Component
{
	...
	private StudentPreviewSourceTableAdapter _studentPreviewSourceTableAdapter;
	...
	public StudentPreviewSourceTableAdapter StudentPreviewSourceTableAdapter
	{
		get
		{
			return _studentPreviewSourceTableAdapter;
		}
		set
		{
			_studentPreviewSourceTableAdapter = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_studentPreviewSourceTableAdapter != null && _studentPreviewSourceTableAdapter.Connection != null)
			{
				return _studentPreviewSourceTableAdapter.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_studentPreviewSourceTableAdapter != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(StudentPreviewSource dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_studentPreviewSourceTableAdapter != null)
		{
			DataRow[] updatedRows = dataSet._StudentPreviewSource.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _studentPreviewSourceTableAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(StudentPreviewSource dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_studentPreviewSourceTableAdapter != null)
		{
			DataRow[] array = dataSet._StudentPreviewSource.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _studentPreviewSourceTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(StudentPreviewSource dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_studentPreviewSourceTableAdapter != null)
		{
			DataRow[] array = dataSet._StudentPreviewSource.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _studentPreviewSourceTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(StudentPreviewSource dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_studentPreviewSourceTableAdapter != null && !MatchTableAdapterConnection(_studentPreviewSourceTableAdapter.Connection))
		{
		...
		try
		{
			if (_studentPreviewSourceTableAdapter != null)
			{
				dictionary.Add(_studentPreviewSourceTableAdapter, _studentPreviewSourceTableAdapter.Connection);
				_studentPreviewSourceTableAdapter.Connection = (SqlConnection)connection;
				_studentPreviewSourceTableAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_studentPreviewSourceTableAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_studentPreviewSourceTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_studentPreviewSourceTableAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_studentPreviewSourceTableAdapter != null)
			{
				_studentPreviewSourceTableAdapter.Connection = (SqlConnection)dictionary[_studentPreviewSourceTableAdapter];
				_studentPreviewSourceTableAdapter.Transaction = null;
			}
			if (0 < list3.Count)
			{
