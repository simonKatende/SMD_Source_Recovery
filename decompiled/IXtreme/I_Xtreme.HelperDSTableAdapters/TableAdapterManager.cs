...
public class TableAdapterManager : Component
{
	...
	private ALevelGradingScaleTableAdapter _aLevelGradingScaleTableAdapter;
	...
	public ALevelGradingScaleTableAdapter ALevelGradingScaleTableAdapter
	{
		get
		{
			return _aLevelGradingScaleTableAdapter;
		}
		set
		{
			_aLevelGradingScaleTableAdapter = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_aLevelGradingScaleTableAdapter != null && _aLevelGradingScaleTableAdapter.Connection != null)
			{
				return _aLevelGradingScaleTableAdapter.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_aLevelGradingScaleTableAdapter != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(HelperDS dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_aLevelGradingScaleTableAdapter != null)
		{
			DataRow[] updatedRows = dataSet.ALevelGradingScale.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _aLevelGradingScaleTableAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(HelperDS dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_aLevelGradingScaleTableAdapter != null)
		{
			DataRow[] array = dataSet.ALevelGradingScale.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _aLevelGradingScaleTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(HelperDS dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_aLevelGradingScaleTableAdapter != null)
		{
			DataRow[] array = dataSet.ALevelGradingScale.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _aLevelGradingScaleTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(HelperDS dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_aLevelGradingScaleTableAdapter != null && !MatchTableAdapterConnection(_aLevelGradingScaleTableAdapter.Connection))
		{
		...
		try
		{
			if (_aLevelGradingScaleTableAdapter != null)
			{
				dictionary.Add(_aLevelGradingScaleTableAdapter, _aLevelGradingScaleTableAdapter.Connection);
				_aLevelGradingScaleTableAdapter.Connection = (SqlConnection)connection;
				_aLevelGradingScaleTableAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_aLevelGradingScaleTableAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_aLevelGradingScaleTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_aLevelGradingScaleTableAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_aLevelGradingScaleTableAdapter != null)
			{
				_aLevelGradingScaleTableAdapter.Connection = (SqlConnection)dictionary[_aLevelGradingScaleTableAdapter];
				_aLevelGradingScaleTableAdapter.Transaction = null;
			}
			if (0 < list3.Count)
			{
