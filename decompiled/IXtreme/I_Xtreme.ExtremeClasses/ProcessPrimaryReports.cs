...
[Serializable]
internal class ProcessPrimaryReports
{
	...
	public static bool SendToDiv3ForF9InEng
	{
		...
		set
		{
			...
			ProcessPrimaryReports processPrimaryReports = new ProcessPrimaryReports();
			using (FileStream fileStream = new FileStream(path, FileMode.Open, FileAccess.Read))
			{
				BinaryFormatter binaryFormatter = new BinaryFormatter();
				processPrimaryReports = (ProcessPrimaryReports)binaryFormatter.Deserialize(fileStream);
				fileStream.Close();
			}
	...
	public static void InitializePrimaryProcessing(DateTime termBegins, string studentclass, string semester, bool sendToDiv3ForF9InEng, bool sendToDiv2ForP8OrP7InEng, bool sendToDiv2ForF9InMTC, bool assignGradeX)
	{
		ProcessPrimaryReports graph = new ProcessPrimaryReports();
		gradeX = assignGradeX;
		Semester = semester;
