...
public class TableAdapterManager : Component
{
	...
	private adapterPrimaryASubDS _adapterPrimaryASubDS;
	...
	public adapterPrimaryASubDS adapterPrimaryASubDS
	{
		get
		{
			return _adapterPrimaryASubDS;
		}
		set
		{
			_adapterPrimaryASubDS = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_adapterPrimaryASubDS != null && _adapterPrimaryASubDS.Connection != null)
			{
				return _adapterPrimaryASubDS.Connection;
			}
			return null;
		}
		set
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(PrimaryASubDS dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_adapterPrimaryASubDS != null)
		{
			DataRow[] updatedRows = dataSet._PrimaryASubDS.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _adapterPrimaryASubDS.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(PrimaryASubDS dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_adapterPrimaryASubDS != null)
		{
			DataRow[] array = dataSet._PrimaryASubDS.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _adapterPrimaryASubDS.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(PrimaryASubDS dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_adapterPrimaryASubDS != null)
		{
			DataRow[] array = dataSet._PrimaryASubDS.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _adapterPrimaryASubDS.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(PrimaryASubDS dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_adapterPrimaryASubDS != null && !MatchTableAdapterConnection(_adapterPrimaryASubDS.Connection))
		{
		...
		try
		{
			if (_adapterPrimaryASubDS != null)
			{
				dictionary.Add(_adapterPrimaryASubDS, _adapterPrimaryASubDS.Connection);
				_adapterPrimaryASubDS.Connection = (SqlConnection)connection;
				_adapterPrimaryASubDS.Transaction = (SqlTransaction)dbTransaction;
				if (_adapterPrimaryASubDS.Adapter.AcceptChangesDuringUpdate)
				{
					_adapterPrimaryASubDS.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_adapterPrimaryASubDS.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_adapterPrimaryASubDS != null)
			{
				_adapterPrimaryASubDS.Connection = (SqlConnection)dictionary[_adapterPrimaryASubDS];
				_adapterPrimaryASubDS.Transaction = null;
			}
			if (0 < list3.Count)
			{
