...
public class TableAdapterManager : Component
{
	...
	private adapterNewCurriculumSubAssessed _adapterNewCurriculumSubAssessed;
	...
	public adapterNewCurriculumSubAssessed adapterNewCurriculumSubAssessed
	{
		get
		{
			return _adapterNewCurriculumSubAssessed;
		}
		set
		{
			_adapterNewCurriculumSubAssessed = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_adapterNewCurriculumSubAssessed != null && _adapterNewCurriculumSubAssessed.Connection != null)
			{
				return _adapterNewCurriculumSubAssessed.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_adapterNewCurriculumSubAssessed != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(NewCurriculumSubReport dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_adapterNewCurriculumSubAssessed != null)
		{
			DataRow[] updatedRows = dataSet.tbl_Scores_OL_Report.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _adapterNewCurriculumSubAssessed.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(NewCurriculumSubReport dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_adapterNewCurriculumSubAssessed != null)
		{
			DataRow[] array = dataSet.tbl_Scores_OL_Report.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _adapterNewCurriculumSubAssessed.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(NewCurriculumSubReport dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_adapterNewCurriculumSubAssessed != null)
		{
			DataRow[] array = dataSet.tbl_Scores_OL_Report.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _adapterNewCurriculumSubAssessed.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(NewCurriculumSubReport dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_adapterNewCurriculumSubAssessed != null && !MatchTableAdapterConnection(_adapterNewCurriculumSubAssessed.Connection))
		{
		...
		try
		{
			if (_adapterNewCurriculumSubAssessed != null)
			{
				dictionary.Add(_adapterNewCurriculumSubAssessed, _adapterNewCurriculumSubAssessed.Connection);
				_adapterNewCurriculumSubAssessed.Connection = (SqlConnection)connection;
				_adapterNewCurriculumSubAssessed.Transaction = (SqlTransaction)dbTransaction;
				if (_adapterNewCurriculumSubAssessed.Adapter.AcceptChangesDuringUpdate)
				{
					_adapterNewCurriculumSubAssessed.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_adapterNewCurriculumSubAssessed.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_adapterNewCurriculumSubAssessed != null)
			{
				_adapterNewCurriculumSubAssessed.Connection = (SqlConnection)dictionary[_adapterNewCurriculumSubAssessed];
				_adapterNewCurriculumSubAssessed.Transaction = null;
			}
			if (0 < list3.Count)
			{
