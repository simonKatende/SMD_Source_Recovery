...
public class TableAdapterManager : Component
{
	...
	private DTableMealCardAdapter _dTableMealCardAdapter;
	...
	public DTableMealCardAdapter DTableMealCardAdapter
	{
		get
		{
			return _dTableMealCardAdapter;
		}
		set
		{
			_dTableMealCardAdapter = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_dTableMealCardAdapter != null && _dTableMealCardAdapter.Connection != null)
			{
				return _dTableMealCardAdapter.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_dTableMealCardAdapter != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(dsMealCardv2 dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_dTableMealCardAdapter != null)
		{
			DataRow[] updatedRows = dataSet.DTableMealCard.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _dTableMealCardAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(dsMealCardv2 dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_dTableMealCardAdapter != null)
		{
			DataRow[] array = dataSet.DTableMealCard.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _dTableMealCardAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(dsMealCardv2 dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_dTableMealCardAdapter != null)
		{
			DataRow[] array = dataSet.DTableMealCard.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _dTableMealCardAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(dsMealCardv2 dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_dTableMealCardAdapter != null && !MatchTableAdapterConnection(_dTableMealCardAdapter.Connection))
		{
		...
		try
		{
			if (_dTableMealCardAdapter != null)
			{
				dictionary.Add(_dTableMealCardAdapter, _dTableMealCardAdapter.Connection);
				_dTableMealCardAdapter.Connection = (SqlConnection)connection;
				_dTableMealCardAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_dTableMealCardAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_dTableMealCardAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_dTableMealCardAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_dTableMealCardAdapter != null)
			{
				_dTableMealCardAdapter.Connection = (SqlConnection)dictionary[_dTableMealCardAdapter];
				_dTableMealCardAdapter.Transaction = null;
			}
			if (0 < list3.Count)
			{
