...
public class TableAdapterManager : Component
{
	...
	private adapterALevelReportMain _adapterALevelReportMain;
	...
	public adapterALevelReportMain adapterALevelReportMain
	{
		get
		{
			return _adapterALevelReportMain;
		}
		set
		{
			_adapterALevelReportMain = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_adapterALevelReportMain != null && _adapterALevelReportMain.Connection != null)
			{
				return _adapterALevelReportMain.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_adapterALevelReportMain != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(ALevelMainReport dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_adapterALevelReportMain != null)
		{
			DataRow[] updatedRows = dataSet.ALevelReportMain.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _adapterALevelReportMain.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(ALevelMainReport dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_adapterALevelReportMain != null)
		{
			DataRow[] array = dataSet.ALevelReportMain.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _adapterALevelReportMain.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(ALevelMainReport dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_adapterALevelReportMain != null)
		{
			DataRow[] array = dataSet.ALevelReportMain.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _adapterALevelReportMain.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(ALevelMainReport dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_adapterALevelReportMain != null && !MatchTableAdapterConnection(_adapterALevelReportMain.Connection))
		{
		...
		try
		{
			if (_adapterALevelReportMain != null)
			{
				dictionary.Add(_adapterALevelReportMain, _adapterALevelReportMain.Connection);
				_adapterALevelReportMain.Connection = (SqlConnection)connection;
				_adapterALevelReportMain.Transaction = (SqlTransaction)dbTransaction;
				if (_adapterALevelReportMain.Adapter.AcceptChangesDuringUpdate)
				{
					_adapterALevelReportMain.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_adapterALevelReportMain.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_adapterALevelReportMain != null)
			{
				_adapterALevelReportMain.Connection = (SqlConnection)dictionary[_adapterALevelReportMain];
				_adapterALevelReportMain.Transaction = null;
			}
			if (0 < list3.Count)
			{
