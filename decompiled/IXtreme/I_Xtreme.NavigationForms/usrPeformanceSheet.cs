...
public class usrPeformanceSheet : XtraUserControl
{
	...
	private void GeneralMarkSheet()
	{
		try
		{
			...
			{
				selectCommandText = $"SELECT TOP (100) PERCENT s.fullName, s.StudentNumber,s.ClassId,s.StreamId,CONVERT(varchar(3),rc.Grade) + '(' + CONVERT(varchar(5),rc.AvMark) + ')' AS Score, og.AvMark As _avMark,og.BestinEight, og.Div, og.Position,Substring (rc.SubjectId,0,4) AS Subject FROM {generalReport} rc INNER JOIN tbl_Stud s ON rc.StudentNumber = s.StudentNumber INNER JOIN {generalReportGrading} og ON rc.StudentNumber = og.StudentNumber AND rc.SemesterId = og.SemesterId WHERE rc.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			}
			else if (schoolType == SchoolSettings.SchoolType.Secondary.ToString())
			{
				selectCommandText = $"SELECT TOP (100) PERCENT s.fullName, s.StudentNumber,s.ClassId,s.StreamId,CONVERT(varchar(3),rc.Grade) + '(' + CONVERT(varchar(5),rc.AvMark) + ')' AS Score, og.AvMark As _avMark,og.BestinEight, og.Div, og.Position,Substring (rc.SubjectId,5,4) AS Subject FROM {generalReport} rc INNER JOIN tbl_Stud s ON rc.StudentNumber = s.StudentNumber INNER JOIN {generalReportGrading} og ON rc.StudentNumber = og.StudentNumber AND rc.SemesterId = og.SemesterId WHERE rc.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			}
			...
			pivotGridMarkSheets.OptionsView.ShowRowGrandTotalHeader = false;
			pivotGridMarkSheets.OptionsView.ShowRowGrandTotals = false;
			pivotGridMarkSheets.OptionsView.ShowRowTotals = false;
			pivotGridMarkSheets.OptionsView.ShowColumnGrandTotalHeader = false;
			pivotGridMarkSheets.OptionsView.ShowColumnGrandTotals = false;
			pivotGridMarkSheets.OptionsView.ShowColumnTotals = false;
			PivotGridField pivotGridField = new PivotGridField("fullName", PivotArea.RowArea)
			{
				Caption = "Name",
				Width = 150
			};
			PivotGridField pivotGridField2 = new PivotGridField("StudentNumber", PivotArea.RowArea)
			{
				Caption = "StudNo.",
				Width = 100
			};
			PivotGridField pivotGridField3 = new PivotGridField("StreamId", PivotArea.FilterArea)
			{
				Caption = "Stream",
				Width = 75
			};
			PivotGridField pivotGridField4 = new PivotGridField("Subject", PivotArea.ColumnArea)
			{
				Caption = "Subject",
				Width = 40
			};
			PivotGridField pivotGridField5 = new PivotGridField("Score", PivotArea.DataArea)
			{
				Caption = "Score",
				Width = 60,
				SummaryType = PivotSummaryType.Max
			};
			PivotGridField pivotGridField6 = new PivotGridField("_avMark", PivotArea.RowArea)
			{
				Caption = "Marks",
				Width = 70,
				SummaryType = PivotSummaryType.Max
			};
			PivotGridField pivotGridField7 = new PivotGridField("BestinEight", PivotArea.RowArea)
			{
				Caption = "Aggr.",
				Width = 65
			};
			PivotGridField pivotGridField8 = new PivotGridField("Div", PivotArea.RowArea)
			{
				Caption = "Div",
				Width = 60
			};
			PivotGridField pivotGridField9 = new PivotGridField("Position", PivotArea.RowArea)
			{
				Caption = "Pos.",
				Width = 60
			};
			...
			pivotGridField7.AreaIndex = 3;
			pivotGridField8.AreaIndex = 4;
			pivotGridField9.AreaIndex = 5;
			pivotGridMarkSheets.Fields.Clear();
			pivotGridMarkSheets.Fields.AddRange(new PivotGridField[9] { pivotGridField8, pivotGridField, pivotGridField2, pivotGridField3, pivotGridField4, pivotGridField5, pivotGridField6, pivotGridField7, pivotGridField9 });
	...
	private void LoadOLevelMarkSheet()
	{
		try
		{
			string text = StudentOptions.ActiveClass().Substring(2, 1);
			using SqlConnection selectConnection = new SqlConnection(DataConnection.ConnectToDatabase());
			double result = 0.0;
			double result2 = 0.0;
			double result3 = 0.0;
			double result4 = 0.0;
			SqlDataAdapter sqlDataAdapter = new SqlDataAdapter($"SELECT * FROM tbl_TermSettings WHERE SemesterId='{StudentOptions.ActiveSemester()}' AND ClassId='{classForProcessing}'", selectConnection);
			...
			if (schoolType == SchoolSettings.SchoolType.Primary.ToString())
			{
				selectCommandText = $"SELECT s.fullName, s.StudentNumber,s.ClassId, s.StreamId, o.SemesterId,Substring(o.SubjectId,0,4) AS SubjectId, o.HoP, o.BOT, o.MOT, o.EOT FROM tbl_Stud s INNER JOIN  {generalReport} o ON s.StudentNumber = o.StudentNumber WHERE o.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			}
			else if (schoolType == SchoolSettings.SchoolType.Secondary.ToString())
			{
				selectCommandText = $"SELECT s.fullName, s.StudentNumber,s.ClassId, s.StreamId, o.SemesterId,Substring(o.SubjectId,5,4) AS SubjectId, o.HoP, o.BOT, o.MOT, o.EOT FROM tbl_Stud s INNER JOIN  {generalReport} o ON s.StudentNumber = o.StudentNumber WHERE o.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			}
			using SqlDataAdapter sqlDataAdapter2 = new SqlDataAdapter(selectCommandText, selectConnection);
			using DataSet dataSet2 = new DataSet();
			sqlDataAdapter2.Fill(dataSet2, "OLevelScores");
			pivotGridMarkSheets.DataSource = dataSet2.Tables[0];
			PivotGridField pivotGridField = new PivotGridField("fullName", PivotArea.RowArea)
			{
				Caption = "Name",
				Width = 155
			};
			PivotGridField pivotGridField2 = new PivotGridField("StreamId", PivotArea.FilterArea)
			{
				Caption = "Stream",
				Width = 75
			};
			PivotGridField pivotGridField3 = new PivotGridField("SubjectId", PivotArea.ColumnArea)
			{
				Caption = "Subject",
				Width = 55
			};
			PivotGridField pivotGridField4 = new PivotGridField("HoP", PivotArea.DataArea)
			{
				Width = 50
			};
			PivotGridField pivotGridField5 = new PivotGridField("BOT", PivotArea.DataArea)
			{
				Width = 50
			};
			PivotGridField pivotGridField6 = new PivotGridField("MOT", PivotArea.DataArea)
			{
				Width = 50
			};
			PivotGridField pivotGridField7 = new PivotGridField("EOT", PivotArea.DataArea)
			{
				Width = 50
			};
			pivotGridField4.SummaryType = PivotSummaryType.Max;
			pivotGridField5.SummaryType = PivotSummaryType.Max;
			pivotGridField6.SummaryType = PivotSummaryType.Max;
			pivotGridField7.SummaryType = PivotSummaryType.Max;
			pivotGridMarkSheets.OptionsView.ShowColumnGrandTotals = false;
			pivotGridMarkSheets.OptionsView.ShowRowGrandTotals = false;
			...
			pivotGridMarkSheets.OptionsView.ShowColumnGrandTotals = false;
			pivotGridMarkSheets.OptionsView.ShowColumnTotals = false;
			pivotGridMarkSheets.Fields.AddRange(new PivotGridField[7] { pivotGridField, pivotGridField2, pivotGridField3, pivotGridField4, pivotGridField5, pivotGridField6, pivotGridField7 });
			PrintableControl.SavePrintableControl(pivotGridMarkSheets);
			MarkSheet.SetMarkSheetViewType("PivotGrid");
		}
		catch (Exception ex)
	...
	private void LoadOLevelPerformanceSheet_Grades()
	{
		try
		{
			pivotGridMarkSheets.OptionsBehavior.BestFitMode = PivotGridBestFitMode.FieldHeader;
			pivotGridMarkSheets.OptionsView.ShowRowGrandTotalHeader = false;
			pivotGridMarkSheets.OptionsView.ShowRowGrandTotals = false;
			pivotGridMarkSheets.OptionsView.ShowRowTotals = false;
			pivotGridMarkSheets.OptionsView.ShowColumnGrandTotalHeader = false;
			...
			if (schoolType == SchoolSettings.SchoolType.Primary.ToString())
			{
				selectCommandText = $"SELECT UPPER(s.fullName) AS fullName,s.Sex,s.ClassId, s.StreamId,UPPER(s.StudentNumber) AS StudentNumber, r.Grade,r.SemesterId,UPPER(Substring(r.SubjectId,0,4)) AS SubjectId,gr.BestinEight,gr.Div FROM {generalReport} r INNER JOIN tbl_Stud s ON r.StudentNumber = s.StudentNumber INNER JOIN {generalReportGrading} gr ON r.StudentNumber = gr.StudentNumber AND r.SemesterId = gr.SemesterId WHERE gr.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			}
			else if (schoolType == SchoolSettings.SchoolType.Secondary.ToString())
			{
				selectCommandText = $"SELECT UPPER(s.fullName) AS fullName,s.Sex,s.ClassId, s.StreamId,UPPER(s.StudentNumber) AS StudentNumber, r.Grade,r.SemesterId,UPPER(Substring(r.SubjectId,5,4)) AS SubjectId,gr.BestinEight,gr.Div FROM {generalReport} r INNER JOIN tbl_Stud s ON r.StudentNumber = s.StudentNumber INNER JOIN {generalReportGrading} gr ON r.StudentNumber = gr.StudentNumber AND r.SemesterId = gr.SemesterId WHERE gr.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			}
			using SqlConnection selectConnection = new SqlConnection(DataConnection.ConnectToDatabase());
			using SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommandText, selectConnection);
			using DataSet dataSet = new DataSet();
			sqlDataAdapter.Fill(dataSet, "OLevelPerformance");
			pivotGridMarkSheets.DataSource = dataSet.Tables[0];
			PivotGridField pivotGridField = new PivotGridField("fullName", PivotArea.RowArea)
			{
				Caption = "Name",
				Width = 150
			...
			PivotGridField pivotGridField4 = new PivotGridField("SubjectId", PivotArea.ColumnArea)
			{
				Caption = "Subject",
				Width = 50
			};
			PivotGridField pivotGridField5 = new PivotGridField("Grade", PivotArea.DataArea)
			{
				Caption = "Grade",
				Width = 60
			};
			PivotGridField pivotGridField6 = new PivotGridField("BestinEight", PivotArea.RowArea)
			{
				Caption = "Agg",
				Width = 60
			};
			PivotGridField pivotGridField7 = new PivotGridField("Div", PivotArea.RowArea)
			{
				Caption = "Div",
				Width = 60
			};
			pivotGridField.Options.AllowExpand = DefaultBoolean.False;
			pivotGridField7.Options.AllowExpand = DefaultBoolean.False;
			...
			pivotGridMarkSheets.Fields.Clear();
			pivotGridMarkSheets.Fields.AddRange(new PivotGridField[7] { pivotGridField, pivotGridField2, pivotGridField3, pivotGridField4, pivotGridField5, pivotGridField6, pivotGridField7 });
			pivotGridField4.BestFit();
			pivotGridField7.BestFit();
			pivotGridField5.BestFit();
			PrintableControl.SavePrintableControl(pivotGridMarkSheets);
			MarkSheet.SetMarkSheetViewType("PivotGrid");
		}
		catch (Exception ex)
	...
	private void LoadOLevelPerformanceSheet()
	{
		try
		{
			pivotGridMarkSheets.OptionsBehavior.BestFitMode = PivotGridBestFitMode.FieldHeader;
			...
			if (schoolType == SchoolSettings.SchoolType.Primary.ToString())
			{
				selectCommandText = $"SELECT UPPER(s.fullName) AS fullName,s.Sex, s.StreamId,UPPER(s.StudentNumber) AS StudentNumber,r.AvMark, r.Grade,r.SemesterId,UPPER(Substring(r.SubjectId,0,4)) AS SubjectId,gr.BestinEight,gr.Div FROM {generalReport} r INNER JOIN tbl_Stud s ON r.StudentNumber = s.StudentNumber INNER JOIN {generalReportGrading} gr ON r.StudentNumber = gr.StudentNumber AND r.SemesterId = gr.SemesterId WHERE gr.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			}
			else if (schoolType == SchoolSettings.SchoolType.Secondary.ToString())
			{
				selectCommandText = $"SELECT UPPER(s.fullName) AS fullName,s.Sex, s.StreamId,UPPER(s.StudentNumber) AS StudentNumber,r.AvMark, r.Grade,r.SemesterId,UPPER(Substring(r.SubjectId,5,4)) AS SubjectId,gr.BestinEight,gr.Div FROM {generalReport} r INNER JOIN tbl_Stud s ON r.StudentNumber = s.StudentNumber INNER JOIN {generalReportGrading} gr ON r.StudentNumber = gr.StudentNumber AND r.SemesterId = gr.SemesterId WHERE gr.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			...
			PivotGridField pivotGridField5 = new PivotGridField("AvMark", PivotArea.DataArea)
			{
				Caption = "Score",
				Width = 45
			};
	...
	private void LoadOLevelAnnualAssessment()
	{
		try
		{
			pivotGridMarkSheets.OptionsBehavior.BestFitMode = PivotGridBestFitMode.FieldHeader;
	...
	private void ShowStudentRanks()
	{
		try
		{
			string text = StudentOptions.ActiveClass().Substring(2, 1);
			using SqlConnection selectConnection = new SqlConnection(DataConnection.ConnectToDatabase());
			string selectCommandText = $"SELECT s.fullName AS Name,g.StudentNumber AS StudNo,s.StreamId AS Stream,g.AvMark,g.Position AS PosInClass,g.positionInStream AS PosInStream,g.BestinEight AS Aggr,g.Div FROM {generalReportGrading} g RIGHT OUTER JOIN tbl_Stud s on g.StudentNumber=s.StudentNumber WHERE g.SemesterId='{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			using SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommandText, selectConnection);
			using DataSet dataSet = new DataSet();
			sqlDataAdapter.Fill(dataSet, "StudentRanking");
			dataSet.Tables[0].Columns.Add("No", typeof(string));
			gridView7.Columns.Clear();
			gridControl5.DataSource = dataSet.Tables["StudentRanking"].DefaultView;
			if (MarkSheet.RankingType == 0)
			{
				gridView7.Columns["Div"].Visible = false;
				gridView7.Columns["Aggr"].Visible = false;
				gridView7.Columns["PosInClass"].Visible = true;
				gridView7.Columns["PosInStream"].Visible = true;
				gridView7.Columns["AvMark"].Visible = true;
			}
			else
			{
				gridView7.Columns["Div"].Visible = true;
				gridView7.Columns["Aggr"].Visible = true;
				gridView7.Columns["PosInClass"].Visible = false;
				gridView7.Columns["PosInStream"].Visible = false;
				gridView7.Columns["AvMark"].Visible = false;
			}
			gridView7.Columns["No"].VisibleIndex = 0;
			gridView7.Columns["No"].BestFit();
			if (MarkSheet.RankingType == 0 && MarkSheet.RankingGroup == 0)
			{
				gridView7.Columns["PosInClass"].Visible = true;
				gridView7.Columns["PosInStream"].Visible = true;
			}
			else if (MarkSheet.RankingType == 0 && MarkSheet.RankingGroup == 1)
			{
				gridView7.Columns["PosInClass"].Visible = true;
				gridView7.Columns["PosInStream"].Visible = false;
			}
			else if (MarkSheet.RankingType == 0 && MarkSheet.RankingGroup == 2)
			{
				gridView7.Columns["PosInClass"].Visible = false;
				gridView7.Columns["PosInStream"].Visible = true;
			}
			gridView7.OptionsView.EnableAppearanceEvenRow = true;
			PrintableControl.SavePrintableControl(gridView7);
			PrintableControl.SavePrintableControl(gridControl5);
	...
	private void GeneralMarkSheetALevel()
	{
		try
		{
			pivotGridMarkSheets.DataSource = MarkSheet.GeneralMarkSheetTable(StudentOptions.ActiveSemester(), classForProcessing);
			pivotGridMarkSheets.OptionsView.ShowRowGrandTotalHeader = false;
			pivotGridMarkSheets.OptionsView.ShowRowGrandTotals = false;
			pivotGridMarkSheets.OptionsView.ShowRowTotals = false;
			pivotGridMarkSheets.OptionsView.ShowColumnGrandTotalHeader = false;
			...
			PivotGridField pivotGridField3 = new PivotGridField("TotalPoints", PivotArea.RowArea)
			{
				Caption = "Pts",
				Width = 70,
				SummaryType = PivotSummaryType.Max
			};
			PivotGridField pivotGridField4 = new PivotGridField("StreamId", PivotArea.FilterArea)
			{
				Caption = "Stream",
				Width = 75
			};
			PivotGridField pivotGridField5 = new PivotGridField("SubjectId", PivotArea.ColumnArea)
			{
				Caption = "Subject",
				Width = 40
			};
			PivotGridField pivotGridField6 = new PivotGridField("Scores", PivotArea.DataArea)
			{
				Caption = "Score",
				Width = 70,
				SummaryType = PivotSummaryType.Max
			...
			pivotGridField.AreaIndex = 0;
			pivotGridField2.AreaIndex = 1;
			pivotGridField3.AllowedAreas = PivotGridAllowedAreas.RowArea;
			pivotGridField.AllowedAreas = PivotGridAllowedAreas.RowArea;
			pivotGridField2.AllowedAreas = PivotGridAllowedAreas.RowArea;
			pivotGridField5.AllowedAreas = PivotGridAllowedAreas.ColumnArea;
			pivotGridField6.AllowedAreas = PivotGridAllowedAreas.DataArea;
			pivotGridField4.AllowedAreas = PivotGridAllowedAreas.FilterArea;
			pivotGridMarkSheets.Fields.Clear();
			pivotGridMarkSheets.Fields.AddRange(new PivotGridField[6] { pivotGridField, pivotGridField2, pivotGridField4, pivotGridField5, pivotGridField6, pivotGridField3 });
			PrintableControl.SavePrintableControl(pivotGridMarkSheets);
			MarkSheet.SetMarkSheetViewType("PivotGrid");
		}
		catch (Exception ex)
	...
	private void LoadALevelMarkSheet_Score()
	{
		try
		{
			using SqlConnection selectConnection = new SqlConnection(DataConnection.ConnectToDatabase());
			string selectCommandText = $"SELECT a.SemesterId, a.Grade,UPPER(Substring(a.SubjectId,0,5)) AS SubjectId,UPPER(s.fullName) AS fullName, UPPER(s.StudentNumber) AS StudentNumber,s.StreamId,s.ClassId FROM tbl_ALevelReport a INNER JOIN tbl_Stud s ON a.StudentNumber = s.StudentNumber WHERE a.SemesterId='{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'";
			using SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommandText, selectConnection);
			using DataSet dataSet = new DataSet();
			sqlDataAdapter.Fill(dataSet, "ALevelReport");
			pivotGridMarkSheets.DataSource = dataSet.Tables["ALevelReport"];
			PivotGridField pivotGridField = new PivotGridField("fullName", PivotArea.RowArea)
			{
				Caption = "Name",
				Width = 200
			...
			pivotGridMarkSheets.OptionsView.ShowColumnGrandTotals = false;
			pivotGridMarkSheets.OptionsView.ShowColumnTotals = false;
			pivotGridMarkSheets.Fields.AddRange(new PivotGridField[5] { pivotGridField, pivotGridField2, pivotGridField3, pivotGridField4, pivotGridField5 });
			pivotGridField.Options.AllowExpand = DefaultBoolean.True;
			PrintableControl.SavePrintableControl(pivotGridMarkSheets);
			MarkSheet.SetMarkSheetViewType("PivotGrid");
		}
		catch (Exception ex)
	...
	private void LoadALevelMarkSheet_Performance()
	{
		try
		{
			using SqlConnection selectConnection = new SqlConnection(DataConnection.ConnectToDatabase());
			using SqlDataAdapter sqlDataAdapter = new SqlDataAdapter($"SELECT s.StudentNumber,UPPER(s.fullName) AS Name,(s.StreamId) AS Stream,s.ClassId,UPPER(Substring(a.SubjectId,0,5)) AS SubjectId,a.AvMark ,a.Category,a.Grade,a.AverageMark FROM tbl_ALevelReport a INNER JOIN tbl_Stud s ON s.StudentNumber=a.StudentNumber WHERE a.SemesterId='{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}'", selectConnection);
			using DataSet dataSet = new DataSet();
			sqlDataAdapter.Fill(dataSet, "ALevelReport");
			pivotGridMarkSheets.DataSource = dataSet.Tables["ALevelReport"];
			PivotGridField pivotGridField = new PivotGridField("Name", PivotArea.RowArea)
			{
				Caption = "Name",
				Width = 200
			};
			...
			PivotGridField pivotGridField3 = new PivotGridField("Stream", PivotArea.FilterArea)
			{
				Caption = "Stream",
				Width = 75
			};
			...
			PivotGridField pivotGridField5 = new PivotGridField("AverageMark", PivotArea.DataArea)
			{
			...
			pivotGridField2.AreaIndex = 1;
			pivotGridMarkSheets.Fields.Clear();
			pivotGridField5.CellFormat.FormatType = FormatType.Numeric;
			pivotGridField5.CellFormat.FormatString = "#";
			pivotGridMarkSheets.OptionsView.ShowRowGrandTotalHeader = false;
			pivotGridMarkSheets.OptionsView.ShowRowGrandTotals = false;
			pivotGridMarkSheets.OptionsView.ShowRowTotals = false;
			pivotGridMarkSheets.OptionsView.ShowColumnGrandTotalHeader = false;
	...
	private void LoadALevelMarkSheet()
	{
		try
		{
			using SqlConnection selectConnection = new SqlConnection(DataConnection.ConnectToDatabase());
			...
			double result3 = 0.0;
			double result4 = 0.0;
			SqlDataAdapter sqlDataAdapter = new SqlDataAdapter($"SELECT * FROM tbl_TermSettings WHERE SemesterId='{StudentOptions.ActiveSemester()}' AND ClassId='{StudentOptions.ActiveClass()}'", selectConnection);
			DataSet dataSet = new DataSet();
			sqlDataAdapter.Fill(dataSet, "GradingRatios");
			foreach (DataRow row in dataSet.Tables[0].Rows)
			{
			...
			string selectCommandText = $"SELECT (s.fullName) AS Name, UPPER(s.StudentNumber) AS StudentNumber,s.Sex,s.StreamId AS Stream,s.ClassId, r.TotalPoints AS Pts,r.HoP,r.BOT,r.MOT,r.EOT,Substring(r.SubjectId,0,4) AS SubjectId,Substring(r.Paper,6,1) AS Paper FROM tbl_ALevelReport r INNER JOIN tbl_Stud s ON s.StudentNumber=r.StudentNumber WHERE r.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}' GROUP BY s.fullName, s.StudentNumber, s.Sex, s.StreamId,s.ClassId, r.SemesterId, r.TotalPoints,r.HoP,r.BOT,r.MOT,r.EOT,r.SubjectId,r.Paper";
			using SqlDataAdapter sqlDataAdapter2 = new SqlDataAdapter(selectCommandText, selectConnection);
			using DataSet dataSet2 = new DataSet();
			sqlDataAdapter2.Fill(dataSet2, "ALevelReport");
			pivotGridMarkSheets.DataSource = dataSet2.Tables["ALevelReport"];
			PivotGridField pivotGridField = new PivotGridField("Name", PivotArea.RowArea)
			{
				Caption = "Name",
				Width = 150
			};
			PivotGridField pivotGridField2 = new PivotGridField("Stream", PivotArea.FilterArea)
			{
				Caption = "Stream",
				Width = 75
			};
			...
			PivotGridField pivotGridField4 = new PivotGridField("Paper", PivotArea.ColumnArea)
			{
				Caption = "Paper",
				Width = 40
			};
			PivotGridField pivotGridField5 = new PivotGridField("HoP", PivotArea.DataArea)
			{
				Width = 40
			};
			PivotGridField pivotGridField6 = new PivotGridField("BOT", PivotArea.DataArea)
			{
				Width = 40
			};
			PivotGridField pivotGridField7 = new PivotGridField("MOT", PivotArea.DataArea)
			{
				Width = 40
			};
			PivotGridField pivotGridField8 = new PivotGridField("EOT", PivotArea.DataArea)
			{
				Width = 40
			};
			pivotGridField5.SummaryType = PivotSummaryType.Max;
			pivotGridField6.SummaryType = PivotSummaryType.Max;
			pivotGridField7.SummaryType = PivotSummaryType.Max;
			pivotGridField8.SummaryType = PivotSummaryType.Max;
			pivotGridField3.AreaIndex = 0;
			pivotGridField4.AreaIndex = 1;
			pivotGridField5.AreaIndex = 0;
			pivotGridField6.AreaIndex = 1;
			...
			pivotGridMarkSheets.OptionsView.ShowColumnGrandTotals = false;
			pivotGridMarkSheets.OptionsView.ShowColumnTotals = false;
			pivotGridMarkSheets.Fields.AddRange(new PivotGridField[8] { pivotGridField, pivotGridField2, pivotGridField3, pivotGridField4, pivotGridField5, pivotGridField6, pivotGridField7, pivotGridField8 });
			PrintableControl.SavePrintableControl(pivotGridMarkSheets);
			MarkSheet.SetMarkSheetViewType("PivotGrid");
		}
		catch (Exception ex)
	...
	private void LoadALevelMarkSheet_Points()
	{
		try
		{
			...
			using SqlConnection selectConnection = new SqlConnection(DataConnection.ConnectToDatabase());
			string selectCommandText = $"SELECT (s.fullName) AS Name, UPPER(s.StudentNumber) AS StudentNumber,s.Sex,s.StreamId AS Stream,s.ClassId, r.TotalPoints AS Pts FROM tbl_ALevelReport r INNER JOIN tbl_Stud s ON s.StudentNumber=r.StudentNumber WHERE r.SemesterId = '{StudentOptions.ActiveSemester()}' AND s.ClassId='{classForProcessing}' GROUP BY s.fullName, s.StudentNumber, s.Sex, s.StreamId,s.ClassId, r.SemesterId, r.TotalPoints";
			using SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommandText, selectConnection);
			using DataSet dataSet = new DataSet();
			sqlDataAdapter.Fill(dataSet, "ALevelReport");
			dataSet.Tables[0].Columns.Add("No", typeof(string));
			gridView7.Columns.Clear();
			gridControl5.DataSource = dataSet.Tables["ALevelReport"].DefaultView;
			gridView7.Columns["Sex"].Width = 30;
			gridView7.Columns["Stream"].Width = 50;
			gridView7.Columns["Pts"].Width = 30;
			gridView7.Columns["No"].VisibleIndex = 0;
			gridView7.Columns["No"].BestFit();
			gridView7.OptionsView.EnableAppearanceEvenRow = true;
			PrintableControl.SavePrintableControl(gridView7);
			PrintableControl.SavePrintableControl(gridControl5);
			MarkSheet.SetMarkSheetViewType("GridControl");
			MarkSheet.SetGridViewType("Points");
		}
		catch (Exception ex)
		{
			XtraMessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
	...
	private void InitializeAllMarkSheets()
	{
		try
		{
			if (MarkSheet.MarkSheetType() == "MarkSheet")
			{
				if (SchoolSettings.SchoolGeneralCurriculum == SchoolSettings.SchoolType.Secondary.ToString() && SchoolSettings.ClassLevel(classForProcessing) == SchoolSettings.SecondaryClassLevels.ALevel.ToString())
				{
					LoadALevelMarkSheet();
				}
				else
			...
			else if (MarkSheet.MarkSheetType() == "Performance")
			{
				if (SchoolSettings.SchoolGeneralCurriculum == SchoolSettings.SchoolType.Secondary.ToString() && SchoolSettings.ClassLevel(classForProcessing) == SchoolSettings.SecondaryClassLevels.ALevel.ToString())
				{
					LoadALevelMarkSheet_Performance();
				}
				else
				{
					LoadOLevelPerformanceSheet();
				}
			}
			else if (MarkSheet.MarkSheetType() == "Grading")
			{
				if (SchoolSettings.SchoolGeneralCurriculum == SchoolSettings.SchoolType.Secondary.ToString() && SchoolSettings.ClassLevel(classForProcessing) == SchoolSettings.SecondaryClassLevels.ALevel.ToString())
				{
					LoadALevelMarkSheet_Score();
				}
				else
				{
					LoadOLevelPerformanceSheet_Grades();
				}
			}
			else if (MarkSheet.MarkSheetType() == "Points")
			{
				LoadALevelMarkSheet_Points();
			}
			else if (MarkSheet.MarkSheetType() == "Ranking")
			{
				ShowStudentRanks();
			}
			else if (MarkSheet.MarkSheetType() == "General")
			{
				if (SchoolSettings.SchoolGeneralCurriculum == SchoolSettings.SchoolType.Secondary.ToString() && SchoolSettings.ClassLevel(classForProcessing) == SchoolSettings.SecondaryClassLevels.ALevel.ToString())
				{
					GeneralMarkSheetALevel();
				}
				else
				{
					GeneralMarkSheet();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(I_Xtreme.NavigationForms.usrPeformanceSheet));
		...
		this.lblWorkStation.TextAlignment = System.Drawing.StringAlignment.Near;
		this.lblAccountAction.Id = 426;
		this.lblAccountAction.Name = "lblAccountAction";
		this.lblAccountAction.TextAlignment = System.Drawing.StringAlignment.Near;
		...
		this.lblWorkingSemester.TextAlignment = System.Drawing.StringAlignment.Near;
		...
		this.lblMarkType.TextAlignment = System.Drawing.StringAlignment.Near;
		...
		this.lblSelectedClass.TextAlignment = System.Drawing.StringAlignment.Near;
		...
		this.barButtonItem169.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem169.Glyph");
		this.barButtonItem169.Id = 597;
		this.barButtonItem169.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem169.LargeGlyph");
		...
		this.barButtonItem172.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem172.Glyph");
		this.barButtonItem172.Id = 598;
		this.barButtonItem172.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem172.LargeGlyph");
		...
		this.barButtonItem173.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem173.Glyph");
		this.barButtonItem173.Id = 599;
		this.barButtonItem173.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem173.LargeGlyph");
		this.barButtonItem173.Name = "barButtonItem173";
		this.barButtonItem174.Caption = "About";
		this.barButtonItem174.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem174.Glyph");
		this.barButtonItem174.Id = 600;
		this.barButtonItem174.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem174.LargeGlyph");
		...
		this.barButtonItem133.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem133.Glyph");
		this.barButtonItem133.Id = 530;
		this.barButtonItem133.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem133.LargeGlyph");
		this.barButtonItem133.Name = "barButtonItem133";
		this.barButtonItem134.Caption = "Delete";
		this.barButtonItem134.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem134.Glyph");
		this.barButtonItem134.Id = 531;
		this.barButtonItem134.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem134.LargeGlyph");
		...
		this.barButtonItem17.Glyph = I_Xtreme.Properties.Resources._16fullList;
		this.barButtonItem17.Id = 96;
		this.barButtonItem17.LargeGlyph = I_Xtreme.Properties.Resources.fullList;
		...
		this.barButtonItem213.Glyph = I_Xtreme.Properties.Resources._16emptyLists;
		this.barButtonItem213.Id = 667;
		this.barButtonItem213.LargeGlyph = I_Xtreme.Properties.Resources.emptyLists;
		...
		this.barButtonItem205.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem205.Glyph");
		this.barButtonItem205.Id = 652;
		this.barButtonItem205.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem205.LargeGlyph");
		...
		this.barButtonItem93.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem93.Glyph");
		this.barButtonItem93.Id = 458;
		this.barButtonItem93.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem93.LargeGlyph");
		this.barButtonItem93.Name = "barButtonItem93";
		this.barButtonItem94.Caption = "Next";
		this.barButtonItem94.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem94.Glyph");
		this.barButtonItem94.Id = 459;
		this.barButtonItem94.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem94.LargeGlyph");
		...
		this.barButtonItem142.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem142.Glyph");
		this.barButtonItem142.Id = 539;
		this.barButtonItem142.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem142.LargeGlyph");
		...
		this.barButtonAGS.Glyph = (System.Drawing.Image)resources.GetObject("barButtonAGS.Glyph");
		this.barButtonAGS.Id = 100;
		this.barButtonAGS.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonAGS.LargeGlyph");
		...
		this.barButtonItem182.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem182.Glyph");
		this.barButtonItem182.Id = 609;
		this.barButtonItem182.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem182.LargeGlyph");
		this.barButtonItem182.Name = "barButtonItem182";
		this.barButtonItem185.Caption = "Refresh";
		this.barButtonItem185.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem185.Glyph");
		this.barButtonItem185.Id = 612;
		this.barButtonItem185.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem185.LargeGlyph");
		this.barButtonItem185.Name = "barButtonItem185";
		this.barButtonItem189.Caption = "Email";
		this.barButtonItem189.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem189.Glyph");
		this.barButtonItem189.Id = 617;
		this.barButtonItem189.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem189.LargeGlyph");
		...
		this.barButtonItem124.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem124.Glyph");
		this.barButtonItem124.Id = 517;
		this.barButtonItem124.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem124.LargeGlyph");
		this.barButtonItem124.Name = "barButtonItem124";
		this.barButtonItem125.Caption = "Next";
		this.barButtonItem125.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem125.Glyph");
		this.barButtonItem125.Id = 518;
		this.barButtonItem125.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem125.LargeGlyph");
		...
		this.barButtonItem83.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem83.Glyph");
		this.barButtonItem83.Id = 448;
		this.barButtonItem83.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem83.LargeGlyph");
		...
		this.barButtonItem73.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem73.Glyph");
		this.barButtonItem73.Id = 430;
		this.barButtonItem73.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem73.LargeGlyph");
		this.barButtonItem73.Name = "barButtonItem73";
		this.barButtonItem74.Caption = "Preview";
		this.barButtonItem74.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem74.Glyph");
		this.barButtonItem74.Id = 431;
		this.barButtonItem74.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem74.LargeGlyph");
		this.barButtonItem74.Name = "barButtonItem74";
		this.barButtonItem177.Caption = "Export";
		this.barButtonItem177.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem177.Glyph");
		this.barButtonItem177.Id = 604;
		this.barButtonItem177.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem177.LargeGlyph");
		...
		this.barButtonItem180.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem180.Glyph");
		this.barButtonItem180.Id = 607;
		this.barButtonItem180.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem180.LargeGlyph");
		...
		this.barButtonItem181.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem181.Glyph");
		this.barButtonItem181.Id = 608;
		this.barButtonItem181.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem181.LargeGlyph");
		...
		this.barButtonItem187.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem187.Glyph");
		this.barButtonItem187.Id = 615;
		this.barButtonItem187.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem187.LargeGlyph");
		...
		this.barButtonItem186.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem186.Glyph");
		this.barButtonItem186.Id = 614;
		this.barButtonItem186.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem186.LargeGlyph");
		...
		this.barButtonAddDeliveries.Glyph = (System.Drawing.Image)resources.GetObject("barButtonAddDeliveries.Glyph");
		this.barButtonAddDeliveries.Id = 110;
		this.barButtonAddDeliveries.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonAddDeliveries.LargeGlyph");
		...
		this.barButtonItem101.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem101.Glyph");
		this.barButtonItem101.Id = 474;
		this.barButtonItem101.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem101.LargeGlyph");
		...
		this.barButtonItem75.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem75.Glyph");
		this.barButtonItem75.Id = 432;
		this.barButtonItem75.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem75.LargeGlyph");
		this.barButtonItem75.Name = "barButtonItem75";
		this.barButtonItem76.Caption = "Preview";
		this.barButtonItem76.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem76.Glyph");
		this.barButtonItem76.Id = 433;
		this.barButtonItem76.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem76.LargeGlyph");
		this.barButtonItem76.Name = "barButtonItem76";
		this.barButtonItem178.Caption = "Export";
		this.barButtonItem178.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem178.Glyph");
		this.barButtonItem178.Id = 605;
		this.barButtonItem178.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem178.LargeGlyph");
		...
		this.barBtnSelectSubjects.Glyph = (System.Drawing.Image)resources.GetObject("barBtnSelectSubjects.Glyph");
		this.barBtnSelectSubjects.Id = 62;
		this.barBtnSelectSubjects.LargeGlyph = (System.Drawing.Image)resources.GetObject("barBtnSelectSubjects.LargeGlyph");
		...
		this.barButtonItem188.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem188.Glyph");
		this.barButtonItem188.Id = 616;
		this.barButtonItem188.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem188.LargeGlyph");
		...
		this.ribbonPageGroup15.AllowMinimize = false;
		...
		this.ribbonPageGroup17.AllowMinimize = false;
		...
		this.barButtonItem67.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem67.LargeGlyph");
		...
		this.ribbonPageGroup48.ShowCaptionButton = false;
		...
		this.barButtonItem214.Glyph = I_Xtreme.Properties.Resources.promote16;
		this.barButtonItem214.Id = 668;
		this.barButtonItem214.LargeGlyph = I_Xtreme.Properties.Resources.promote32;
		...
		toolTipTitleItem51.Image = I_Xtreme.Properties.Resources.help;
		...
		toolTipTitleItem53.Image = I_Xtreme.Properties.Resources.help;
		...
		this.barButtonItem212.Glyph = I_Xtreme.Properties.Resources.counter16;
		this.barButtonItem212.Id = 661;
		this.barButtonItem212.LargeGlyph = I_Xtreme.Properties.Resources.counter32;
		...
		toolTipTitleItem55.Image = I_Xtreme.Properties.Resources.help;
		...
		this.barButtonItem154.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem154.Glyph");
		this.barButtonItem154.Id = 570;
		this.barButtonItem154.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem154.LargeGlyph");
		this.barButtonItem154.Name = "barButtonItem154";
		this.barButtonItem153.Caption = "Fixed Assets";
		this.barButtonItem153.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem153.Glyph");
		this.barButtonItem153.Id = 569;
		this.barButtonItem153.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem153.LargeGlyph");
		...
		this.barButtonItem159.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem159.Glyph");
		this.barButtonItem159.Id = 578;
		this.barButtonItem159.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem159.LargeGlyph");
		...
		this.barButtonItem160.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem160.Glyph");
		this.barButtonItem160.Id = 579;
		this.barButtonItem160.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem160.LargeGlyph");
		...
		this.barButtonItem99.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem99.Glyph");
		this.barButtonItem99.Id = 472;
		this.barButtonItem99.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem99.LargeGlyph");
		...
		this.barButtonItem194.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem194.Glyph");
		this.barButtonItem194.Id = 623;
		this.barButtonItem194.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem194.LargeGlyph");
		this.barButtonItem194.Name = "barButtonItem194";
		this.barButtonItem195.Caption = "Preview";
		this.barButtonItem195.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem195.Glyph");
		this.barButtonItem195.Id = 624;
		this.barButtonItem195.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem195.LargeGlyph");
		this.barButtonItem195.Name = "barButtonItem195";
		this.barButtonItem206.Caption = "Export";
		this.barButtonItem206.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem206.Glyph");
		this.barButtonItem206.Id = 654;
		this.barButtonItem206.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem206.LargeGlyph");
		...
		this.barButtonGS.Glyph = (System.Drawing.Image)resources.GetObject("barButtonGS.Glyph");
		this.barButtonGS.Id = 156;
		this.barButtonGS.Name = "barButtonGS";
		this.barButtonItemDS.Caption = "Division scale";
		this.barButtonItemDS.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItemDS.Glyph");
		...
		this.barButtonPB.Glyph = (System.Drawing.Image)resources.GetObject("barButtonPB.Glyph");
		...
		this.barButtonAllSets.Glyph = (System.Drawing.Image)resources.GetObject("barButtonAllSets.Glyph");
		this.barButtonAllSets.Id = 244;
		this.barButtonAllSets.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonAllSets.LargeGlyph");
		...
		this.barButtonItem68.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem68.LargeGlyph");
		this.barButtonItem68.Name = "barButtonItem68";
		this.barButtonItem69.Caption = "Close";
		this.barButtonItem69.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem69.Glyph");
		...
		this.barButtonItem70.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem70.Glyph");
		...
		this.barButtonItemPrintIE.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItemPrintIE.Glyph");
		this.barButtonItemPrintIE.Id = 427;
		this.barButtonItemPrintIE.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItemPrintIE.LargeGlyph");
		this.barButtonItemPrintIE.Name = "barButtonItemPrintIE";
		this.barButtonItem71.Caption = "Print";
		this.barButtonItem71.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem71.Glyph");
		...
		this.barButtonItem72.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem72.Glyph");
		this.barButtonItem72.Id = 429;
		this.barButtonItem72.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem72.LargeGlyph");
		...
		this.barButtonItem79.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem79.Glyph");
		this.barButtonItem79.Id = 436;
		this.barButtonItem79.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem79.LargeGlyph");
		...
		this.barEditItem7.Glyph = (System.Drawing.Image)resources.GetObject("barEditItem7.Glyph");
		this.barEditItem7.Id = 443;
		this.barEditItem7.LargeGlyph = (System.Drawing.Image)resources.GetObject("barEditItem7.LargeGlyph");
		this.barEditItem7.Name = "barEditItem7";
		this.barEditItem7.Width = 80;
		...
		this.barButtonItem82.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem82.Glyph");
		this.barButtonItem82.Id = 444;
		this.barButtonItem82.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem82.LargeGlyph");
		...
		this.cboSemesterBudget.Glyph = (System.Drawing.Image)resources.GetObject("cboSemesterBudget.Glyph");
		...
		this.cboSemesterBudget.Width = 100;
		this.cboBudgetAnnual.Edit = null;
		this.cboBudgetAnnual.Glyph = (System.Drawing.Image)resources.GetObject("cboBudgetAnnual.Glyph");
		this.cboBudgetAnnual.Id = 447;
		this.cboBudgetAnnual.Name = "cboBudgetAnnual";
		this.cboBudgetAnnual.Width = 100;
		...
		this.barButtonItem91.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem91.Glyph");
		...
		this.barButtonItem100.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem100.Glyph");
		this.barButtonItem100.Id = 475;
		this.barButtonItem100.Name = "barButtonItem100";
		this.barButtonItem103.Caption = "Report Comments";
		this.barButtonItem103.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem103.Glyph");
		...
		this.barButtonItem117.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem117.Glyph");
		this.barButtonItem117.Id = 499;
		this.barButtonItem117.Name = "barButtonItem117";
		this.barButtonItem118.Caption = "Log out";
		this.barButtonItem118.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem118.Glyph");
		this.barButtonItem118.Id = 500;
		this.barButtonItem118.Name = "barButtonItem118";
		this.barButtonItem119.Caption = "Change Bank";
		this.barButtonItem119.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem119.Glyph");
		...
		this.barButtonItem122.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem122.Glyph");
		this.barButtonItem122.Id = 515;
		this.barButtonItem122.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem122.LargeGlyph");
		...
		this.barButtonItem123.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem123.Glyph");
		this.barButtonItem123.Id = 516;
		this.barButtonItem123.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem123.LargeGlyph");
		...
		this.barButtonItem126.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem126.Glyph");
		this.barButtonItem126.Id = 519;
		this.barButtonItem126.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem126.LargeGlyph");
		...
		this.barButtonItem127.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem127.Glyph");
		this.barButtonItem127.Id = 524;
		this.barButtonItem127.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem127.LargeGlyph");
		...
		this.barButtonItem131.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem131.Glyph");
		this.barButtonItem131.Id = 528;
		this.barButtonItem131.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem131.LargeGlyph");
		...
		this.barButtonItem132.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem132.Glyph");
		this.barButtonItem132.Id = 529;
		this.barButtonItem132.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem132.LargeGlyph");
		this.barButtonItem132.Name = "barButtonItem132";
		this.barButtonItem136.Caption = "Delete";
		this.barButtonItem136.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem136.Glyph");
		this.barButtonItem136.Id = 533;
		this.barButtonItem136.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem136.LargeGlyph");
		this.barButtonItem136.Name = "barButtonItem136";
		this.barButtonItem137.Caption = "Home";
		this.barButtonItem137.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem137.Glyph");
		this.barButtonItem137.Id = 534;
		this.barButtonItem137.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem137.LargeGlyph");
		this.barButtonItem137.Name = "barButtonItem137";
		this.barButtonItem138.Caption = "Print";
		this.barButtonItem138.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem138.Glyph");
		this.barButtonItem138.Id = 535;
		this.barButtonItem138.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem138.LargeGlyph");
		this.barButtonItem138.Name = "barButtonItem138";
		this.barButtonItem139.Caption = "Preview";
		this.barButtonItem139.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem139.Glyph");
		this.barButtonItem139.Id = 536;
		this.barButtonItem139.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem139.LargeGlyph");
		this.barButtonItem139.Name = "barButtonItem139";
		this.barButtonItem140.Caption = "Export";
		this.barButtonItem140.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem140.Glyph");
		this.barButtonItem140.Id = 537;
		this.barButtonItem140.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem140.LargeGlyph");
		...
		this.barButtonItem143.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem143.Glyph");
		this.barButtonItem143.Id = 540;
		this.barButtonItem143.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem143.LargeGlyph");
		...
		this.barButtonItem148.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem148.Glyph");
		this.barButtonItem148.Id = 545;
		this.barButtonItem148.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem148.LargeGlyph");
		this.barButtonItem148.Name = "barButtonItem148";
		this.barButtonItem149.Caption = "Home";
		this.barButtonItem149.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem149.Glyph");
		this.barButtonItem149.Id = 546;
		this.barButtonItem149.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem149.LargeGlyph");
		...
		this.barButtonItem151.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem151.Glyph");
		this.barButtonItem151.Id = 556;
		this.barButtonItem151.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem151.LargeGlyph");
		...
		this.barCBOSemester.Width = 150;
		this.barCBOSemesterIncome.Edit = null;
		this.barCBOSemesterIncome.Id = 565;
		this.barCBOSemesterIncome.Name = "barCBOSemesterIncome";
		this.barCBOSemesterIncome.Width = 150;
		this.barButtonItem152.Caption = "Home";
		this.barButtonItem152.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem152.Glyph");
		this.barButtonItem152.Id = 567;
		this.barButtonItem152.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem152.LargeGlyph");
		...
		this.barEditItem12.Width = 100;
		this.barButtonItem170.Caption = "About iXtreme 2014";
		this.barButtonItem170.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem170.Glyph");
		this.barButtonItem170.Id = 591;
		this.barButtonItem170.Name = "barButtonItem170";
		this.barButtonItem171.Caption = "Help";
		this.barButtonItem171.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem171.Glyph");
		...
		this.barButtonItem175.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem175.Glyph");
		this.barButtonItem175.Id = 602;
		this.barButtonItem175.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem175.LargeGlyph");
		...
		this.barButtonItem176.Glyph = (System.Drawing.Image)resources.GetObject("barButtonItem176.Glyph");
		this.barButtonItem176.Id = 603;
		this.barButtonItem176.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem176.LargeGlyph");
		...
		this.barButtonItem179.Glyph = I_Xtreme.Properties.Resources.exp16;
		this.barButtonItem179.Id = 606;
		this.barButtonItem179.LargeGlyph = I_Xtreme.Properties.Resources.exp32;
		...
		this.barButtonItem191.LargeGlyph = (System.Drawing.Image)resources.GetObject("barButtonItem191.LargeGlyph");
		...
		this.lblListType.TextAlignment = System.Drawing.StringAlignment.Near;
		...
		this.pivotGridMarkSheets.Location = new System.Drawing.Point(7, 7);
		...
		this.pivotGridMarkSheets.OptionsPrint.PrintHeadersOnEveryPage = true;
		this.pivotGridMarkSheets.OptionsPrint.UsePrintAppearance = true;
		this.pivotGridMarkSheets.Size = new System.Drawing.Size(359, 526);
		this.pivotGridMarkSheets.TabIndex = 5;
		this.gridControl5.Location = new System.Drawing.Point(370, 7);
		this.gridControl5.MainView = this.gridView7;
		this.gridControl5.Name = "gridControl5";
		this.gridControl5.Size = new System.Drawing.Size(446, 526);
		this.gridControl5.TabIndex = 4;
		this.gridControl5.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[1] { this.gridView7 });
		this.gridView7.Appearance.HeaderPanel.Font = new System.Drawing.Font("Corbel", 8.25f);
		this.gridView7.Appearance.HeaderPanel.Options.UseFont = true;
		this.gridView7.AppearancePrint.HeaderPanel.Font = new System.Drawing.Font("Tahoma", 9.75f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 0);
		...
		this.gridView7.CustomColumnDisplayText += new DevExpress.XtraGrid.Views.Base.CustomColumnDisplayTextEventHandler(gridView7_CustomColumnDisplayText);
		...
		this.layoutControlItem1.Control = this.gridControl5;
		this.layoutControlItem1.CustomizationFormText = "layoutControlItem1";
		this.layoutControlItem1.Location = new System.Drawing.Point(363, 0);
		this.layoutControlItem1.Name = "layoutControlItem1";
		this.layoutControlItem1.Size = new System.Drawing.Size(450, 530);
		...
		this.layoutControlItem2.Size = new System.Drawing.Size(363, 530);
