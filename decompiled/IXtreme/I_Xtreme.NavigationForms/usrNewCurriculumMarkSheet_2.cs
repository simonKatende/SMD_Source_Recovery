...
public class usrNewCurriculumMarkSheet_2 : XtraUserControl
{
	private string Term = "";
	...
	public usrNewCurriculumMarkSheet_2(string Term, string _Class, int reportType)
	{
		InitializeComponent();
		this.Term = Term;
		this._Class = _Class;
	...
	private void LoadMarkSheet()
	{
		try
		{
			...
			string text = $" SELECT s.fullName, s.StreamId, r.SemesterId,Substring(r.SubjectId,5,4) AS SubjectId, r.ClassId, r.U1, r.U2,  r.U3, r.U4, r.Score1, r.Score2, r.Score3, r.Score4, r.Hund1, r.Hund2, r.Hund3, r.Hund4,  r.TTLPoints, r.PrevTTLPoints, r.OutOfTwenty, r.PrevOutOfTwenty, r.OutOfHund, r.PrevOutOfHund, r.TUnits,  r.IsAssessed, r.Initial, r.Grade, r.Category, r.ETA, r.ETA80, r.ETAv, r.Comment, r.AvMark  FROM tbl_Scores_OL_Report r INNER JOIN tbl_Stud s ON r.StudentNumber = s.StudentNumber  WHERE (r.ClassId = '{_Class}') AND(r.SemesterId = '{Term}')";
			string text2 = $" SELECT s.fullName, s.StreamId, r.SemesterId,Substring(r.SubjectId,5,4) AS SubjectId, r.ClassId, r.U1, r.U2,  r.U3, r.U4,r.Hund1 AS Score1, r.Hund2 AS Score2, r.Hund3 AS Score3, r.Hund4 AS Score4, r.TTLPoints, r.PrevTTLPoints, r.PrevOutOfTwenty, r.OutOfHund AS OutOfTwenty, r.PrevOutOfHund, r.TUnits,  r.IsAssessed, r.Initial, r.Grade, r.Category, r.ETA, r.ETA80, r.ETAv, r.Comment, r.AvMark  FROM tbl_Scores_OL_Report r INNER JOIN tbl_Stud s ON r.StudentNumber = s.StudentNumber  WHERE (r.ClassId = '{_Class}') AND(r.SemesterId = '{Term}')";
			if (reportType == 0)
			{
				empty = text;
				subHeader = "End of Term Examination";
			}
			else
			{
				empty = text2;
	...
	private void InitializeComponent()
	{
		...
		this.pivotGridControl1.Fields.AddRange(new DevExpress.XtraPivotGrid.PivotGridField[4] { this.pivotGridField1, this.pivotGridField2, this.pivotGridField13, this.pivotGridField15 });
		...
		this.pivotGridControl1.Size = new System.Drawing.Size(772, 309);
		...
		this.pivotGridField13.Caption = "ETA";
		dataSourceColumnBinding3.ColumnName = "ETA";
		this.pivotGridField13.DataBinding = dataSourceColumnBinding3;
		this.pivotGridField13.Name = "pivotGridField13";
		this.pivotGridField13.SummaryType = DevExpress.Data.PivotGrid.PivotSummaryType.Max;
		...
		dataSourceColumnBinding4.ColumnName = "SubjectId";
		this.pivotGridField15.DataBinding = dataSourceColumnBinding4;
		...
		this.layoutControl1.Size = new System.Drawing.Size(796, 385);
		...
		this.Root.Name = "Root";
		this.Root.Size = new System.Drawing.Size(796, 385);
		...
		this.lblSubHeader.Size = new System.Drawing.Size(772, 19);
		...
		this.lblHeader.Size = new System.Drawing.Size(772, 25);
		...
		this.layoutControlItem1.Size = new System.Drawing.Size(776, 29);
		this.layoutControlItem1.TextSize = new System.Drawing.Size(0, 0);
		this.layoutControlItem1.TextVisible = false;
		this.layoutControlItem2.Control = this.lblSubHeader;
		this.layoutControlItem2.Location = new System.Drawing.Point(0, 29);
		this.layoutControlItem2.Name = "layoutControlItem2";
		this.layoutControlItem2.Size = new System.Drawing.Size(776, 23);
		this.layoutControlItem2.TextSize = new System.Drawing.Size(0, 0);
		this.layoutControlItem2.TextVisible = false;
		this.layoutControlItem3.Control = this.pivotGridControl1;
		this.layoutControlItem3.Location = new System.Drawing.Point(0, 52);
		this.layoutControlItem3.Name = "layoutControlItem3";
		this.layoutControlItem3.Size = new System.Drawing.Size(776, 313);
		this.layoutControlItem3.TextSize = new System.Drawing.Size(0, 0);
		this.layoutControlItem3.TextVisible = false;
		base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.Controls.Add(this.layoutControl1);
		base.Name = "usrNewCurriculumMarkSheet_2";
		base.Size = new System.Drawing.Size(796, 385);
