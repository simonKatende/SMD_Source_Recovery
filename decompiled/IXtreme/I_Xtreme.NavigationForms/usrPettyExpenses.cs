...
public class usrPettyExpenses : XtraUserControl
{
	...
	{
		SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT id, VoucherNo, Date, Qty, Rate, accNo, item, ChequeNo, narration, ExpenseType, Qty * Rate AS TOTAL  FROM tbl_TempVoucher WHERE VoucherNo='" + txtVoucherNo.Text + "' AND VoucherType = 'PettyExpenses'", DataConnection.ConnectToDatabase());
	...
	{
		SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT id, VoucherNo, Date, Qty, Rate, accNo, item, ChequeNo, narration, ExpenseType, Qty * Rate AS TOTAL FROM tbl_TempVoucher WHERE VoucherType = 'PettyExpenses'", DataConnection.ConnectToDatabase());
		DataSet dataSet = new DataSet();
		sqlDataAdapter.Fill(dataSet, "TempItems");
		_dt = new DataTable();
		_dt = dataSet.Tables[0];
	...
	private void DeleteCheque()
	{
		try
		{
			...
			using SqlCommand sqlCommand = new SqlCommand
			{
				...
				CommandText = "DELETE FROM tbl_TempVoucher WHERE VoucherNo=@VoucherNo AND VoucherType = 'PettyExpenses'",
	...
	private void DeleteItem(string accNo, string item)
	{
		try
		{
			...
			{
				Connection = sqlConnection,
				CommandText = "DELETE FROM tbl_TempVoucher WHERE VoucherNo=@VoucherNo AND accNo=@accNo AND VoucherType = 'PettyExpenses'",
				CommandType = CommandType.Text
			};
			SqlParameter sqlParameter = sqlCommand.Parameters.Add("@VoucherNo", SqlDbType.VarChar, 30);
			sqlParameter.Value = txtVoucherNo.Text;
	...
	private void LoadBudgetItems()
	{
		try
		{
			SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT b.AccNo, ga.accName AS Vote, gas.SubAccoutName AS Item,(b.qty * b.rate ) AS TotalEstimate FROM tbl_generalAccounts_Sub gas INNER JOIN tbl_generalAccounts ga ON gas.accNo = ga.accNo INNER JOIN tbl_budget b ON gas.accNo = b.AccNo WHERE b.year=" + FinalAccounts.BooksBeginningDate.Year, DataConnection.ConnectToDatabase());
			DataSet dataSet = new DataSet();
			...
			if (gridView2.GetFocusedDataSourceRowIndex() > -1 && txtChequeNo.Text != null && txtVoucherNo.Text != null)
			{
				...
				if (true)
				{
					...
					if (!sqlDataReader.HasRows)
					{
						...
						{
							Connection = sqlConnection,
							CommandText = "SELECT * FROM tbl_TempVoucher WHERE accNo=@accNo AND ExpenseType=@ExpenseType AND VoucherType = 'PettyExpenses'",
							CommandType = CommandType.Text
						};
						...
						if (!sqlDataReader2.HasRows)
						{
							...
							sqlConnection.Close();
							QtyAmount qtyAmount = new QtyAmount("PettyExpenses");
	...
	private void UpdateTempVoucher()
	{
		try
		{
			...
			{
				Connection = sqlConnection,
				CommandText = "UPDATE tbl_TempVoucher SET Qty=@Qty,Rate=@Rate,Narration=@Narration WHERE accNo=@accNo AND VoucherType = 'PettyExpenses'",
				CommandType = CommandType.Text
			};
	...
	private void CloseCheque()
	{
		try
		{
			...
			empty2 = ((!string.IsNullOrEmpty(txtChequeNo.Text)) ? "Cheque" : "Cash");
			...
			for (int i = 0; i < dragOver.RowCount; i++)
			{
				...
				string value = dragOver.GetRowCellValue(i, "item").ToString();
				string text2 = dragOver.GetRowCellValue(i, "ChequeNo").ToString();
				empty = (VoucherParameters.VoucherNoSelected = dragOver.GetRowCellValue(i, "VoucherNo").ToString());
				string text4 = dragOver.GetRowCellValue(i, "narration").ToString();
				string value2 = dragOver.GetRowCellValue(i, "accNo").ToString();
				...
				})
				{
					...
					sqlParameter.Value = text2 + "-" + empty;
					sqlParameter.Direction = ParameterDirection.Input;
				...
				})
				{
					...
					sqlParameter2.Value = text + "-" + text4;
					sqlParameter2.Direction = ParameterDirection.Input;
					...
					sqlParameter2.Value = text2 + "-" + empty;
					sqlParameter2.Direction = ParameterDirection.Input;
				...
				})
				{
					...
					sqlParameter3.Value = dtVoucherDate.DateTime.ToShortDateString();
					sqlParameter3.Direction = ParameterDirection.Input;
					...
					sqlParameter3.Value = empty2;
					sqlParameter3.Direction = ParameterDirection.Input;
					sqlParameter3 = sqlCommand3.Parameters.Add("@NarrationBig", SqlDbType.NVarChar, 500);
					sqlParameter3.Value = confirmVoucherClose.txtNarration.Text;
					sqlParameter3.Direction = ParameterDirection.Input;
					sqlParameter3 = sqlCommand3.Parameters.Add("@Contact", SqlDbType.NVarChar, 50);
					sqlParameter3.Value = confirmVoucherClose.txtContact.Text;
					sqlParameter3.Direction = ParameterDirection.Input;
					sqlParameter3 = sqlCommand3.Parameters.Add("@Address", SqlDbType.NVarChar, 100);
					sqlParameter3.Value = Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(confirmVoucherClose.txtAddress.Text);
					sqlParameter3.Direction = ParameterDirection.Input;
					sqlParameter3 = sqlCommand3.Parameters.Add("@Payee", SqlDbType.NVarChar, 100);
					sqlParameter3.Value = confirmVoucherClose.txtPayee.Text.ToUpper();
					sqlParameter3.Direction = ParameterDirection.Input;
				...
				using (SqlCommand sqlCommand4 = new SqlCommand
				{
					Connection = sqlConnection,
					Transaction = _trans,
					CommandText = "DELETE FROM tbl_TempVoucher WHERE accNo=@accNo AND VoucherType = 'PettyExpenses'",
					CommandType = CommandType.Text
				})
				{
					SqlParameter sqlParameter4 = sqlCommand4.Parameters.Add("@accNo", SqlDbType.VarChar, 9);
					sqlParameter4.Value = value2;
	...
	private void InitializeComponent()
	{
		...
		this.cboCashAccount.Size = new System.Drawing.Size(187, 24);
		...
		this.simpleButton2.Location = new System.Drawing.Point(195, 280);
		...
		this.simpleButton1.Location = new System.Drawing.Point(195, 254);
		...
		this.txtChequeNo.Size = new System.Drawing.Size(187, 24);
		...
		this.txtStandingBalance.Size = new System.Drawing.Size(187, 26);
		...
		this.gridControl2.Size = new System.Drawing.Size(187, 184);
		...
		this.simpleButton4.Location = new System.Drawing.Point(218, 461);
		...
		this.simpleButton3.Location = new System.Drawing.Point(551, 461);
		this.simpleButton3.Name = "simpleButton3";
		this.simpleButton3.Size = new System.Drawing.Size(315, 23);
		...
		this.dtVoucherDate.Size = new System.Drawing.Size(187, 24);
		...
		this.txtVoucherNo.Size = new System.Drawing.Size(187, 24);
		this.txtVoucherNo.StyleController = this.layoutControl1;
		this.txtVoucherNo.TabIndex = 6;
		this.gridControl1.AllowDrop = true;
		this.gridControl1.Location = new System.Drawing.Point(218, 32);
		...
		this.gridControl1.Size = new System.Drawing.Size(648, 425);
		...
		this.layoutControlItem1.Location = new System.Drawing.Point(214, 28);
		this.layoutControlItem1.Name = "layoutControlItem1";
		this.layoutControlItem1.Size = new System.Drawing.Size(652, 429);
		...
		this.layoutControlItem4.Size = new System.Drawing.Size(191, 44);
		...
		this.layoutControlItem8.Size = new System.Drawing.Size(191, 210);
		...
		this.layoutControlItem9.Size = new System.Drawing.Size(191, 44);
		...
		this.emptySpaceItem2.Location = new System.Drawing.Point(191, 302);
		...
		this.layoutControlItem11.Location = new System.Drawing.Point(191, 276);
		...
		this.emptySpaceItem1.Location = new System.Drawing.Point(191, 28);
		...
		this.layoutControlItem7.Location = new System.Drawing.Point(214, 457);
		...
		this.layoutControlItem6.Location = new System.Drawing.Point(547, 457);
		this.layoutControlItem6.Name = "layoutControlItem6";
		this.layoutControlItem6.Size = new System.Drawing.Size(319, 27);
		this.layoutControlItem6.TextSize = new System.Drawing.Size(0, 0);
		this.layoutControlItem6.TextVisible = false;
		this.layoutControlItem10.Control = this.simpleButton1;
		this.layoutControlItem10.CustomizationFormText = "layoutControlItem10";
		this.layoutControlItem10.Location = new System.Drawing.Point(191, 250);
		...
		this.layoutControlItem2.Size = new System.Drawing.Size(191, 44);
		...
		this.layoutControlItem5.Size = new System.Drawing.Size(191, 46);
		...
		this.layoutControlItem3.Size = new System.Drawing.Size(191, 44);
		...
		this.labelControl1.Text = "Recurrent Expenses";
