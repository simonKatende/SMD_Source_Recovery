...
public class usrScoreboardReview10 : XtraUserControl
{
	...
	public usrScoreboardReview10(string _Class, string Year)
	{
		Dock = DockStyle.Fill;
	...
	{
		SqlDataAdapter sqlDataAdapter = new SqlDataAdapter($"SELECT sc.ClassId AS PrevClass, (s.fullName + '-' + s.StudentNumber + '(' + s.ClassId +')') AS fullName,s.LIN, sc.SemesterId, s.StreamId, sc.SubjectId, sc.OutOfTen, sc.P1, sc.PTotal  FROM            tbl_Stud AS s INNER JOIN     tbl_Scores_OL_Report AS sc ON s.StudentNumber = sc.StudentNumber  WHERE(sc.ClassId = '{_Class}') AND(sc.SemesterId LIKE '%{Year}%')", DataConnection.ConnectToDatabase());
	...
	{
		if (e.ValueType == PivotGridValueType.GrandTotal && e.IsColumn && e.DataField == pivotGridField7)
		{
	...
	private void InitializeComponent()
	{
		...
		this.pivotGridControl1.Fields.AddRange(new DevExpress.XtraPivotGrid.PivotGridField[6] { this.pivotGridField1, this.pivotGridField3, this.pivotGridField6, this.pivotGridField10, this.pivotGridField2, this.pivotGridField7 });
		...
		this.pivotGridControl1.CustomFieldValueCells += new DevExpress.XtraPivotGrid.PivotCustomFieldValueCellsEventHandler(pivotGridControl1_CustomFieldValueCells);
		...
		this.pivotGridField10.DataBinding = dataSourceColumnBinding4;
		...
		dataSourceColumnBinding5.ColumnName = "LIN";
		...
		this.pivotGridField7.Caption = "Score";
		dataSourceColumnBinding6.ColumnName = "OutOfTen";
		this.pivotGridField7.DataBinding = dataSourceColumnBinding6;
		this.pivotGridField7.Name = "pivotGridField7";
		this.pivotGridField7.SortOrder = DevExpress.XtraPivotGrid.PivotSortOrder.Descending;
		this.pivotGridField7.SummaryType = DevExpress.Data.PivotGrid.PivotSummaryType.Average;
		...
		base.Name = "usrScoreboardReview10";
