...
public class usrFeesPaymentAnalysisPayModal : XtraUserControl
{
	...
	public usrFeesPaymentAnalysisPayModal(string PayMode, DateTime dtStart, DateTime dtEnd)
	{
		InitializeComponent();
	...
	private void LoadFeesAnalysis_General()
	{
		try
		{
			...
			empty = string.Format("SELECT s.fullName, s.StudentNumber, p.DateOfPayment, p.Particulars, p.Credit, p.ModeOfPayment FROM   FeesPayment p INNER JOIN tbl_Stud s ON p.StudentNumber = s.StudentNumber WHERE (p.ModeOfPayment = '{0}') AND(p.DateOfPayment >= '{1}' AND p.DateOfPayment <= '{2}')", PayMode, dtStart.ToString("yyyy-M-d"), dtEnd.ToString("yyyy-M-d"));
			ActiveFormSelected.SetActiveForm("Fees Payment Modes Analysis");
			using SqlConnection selectConnection = new SqlConnection(connectionString);
			using SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(empty, selectConnection);
	...
	private void InitializeComponent()
	{
		...
		this.layoutControl1.Size = new System.Drawing.Size(1330, 748);
		...
		this.pivotGridExpenses.Location = new System.Drawing.Point(5, 5);
		this.pivotGridExpenses.Margin = new System.Windows.Forms.Padding(4);
		...
		this.pivotGridExpenses.Size = new System.Drawing.Size(1320, 738);
		...
		this.pivotGridField2.Caption = "StudentNo";
		...
		this.pivotGridField3.CellFormat.FormatString = "dd.MMM.yy";
		this.pivotGridField3.CellFormat.FormatType = DevExpress.Utils.FormatType.DateTime;
		this.pivotGridField3.FieldName = "DateOfPayment";
		this.pivotGridField3.Name = "pivotGridField3";
		this.pivotGridField3.ValueFormat.FormatString = "dd.MMM.yy";
		...
		this.layoutControlGroup1.Size = new System.Drawing.Size(1330, 748);
		this.layoutControlGroup1.TextVisible = false;
		this.layoutControlItem1.Control = this.pivotGridExpenses;
		this.layoutControlItem1.CustomizationFormText = "layoutControlItem1";
		this.layoutControlItem1.Location = new System.Drawing.Point(0, 0);
		this.layoutControlItem1.Name = "layoutControlItem1";
		this.layoutControlItem1.Size = new System.Drawing.Size(1324, 742);
		...
		base.Name = "usrFeesPaymentAnalysisPayModal";
		base.Size = new System.Drawing.Size(1330, 748);
