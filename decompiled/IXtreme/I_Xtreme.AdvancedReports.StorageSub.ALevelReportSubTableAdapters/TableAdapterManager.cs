...
public class TableAdapterManager : Component
{
	...
	private adapterALevelReportSub _adapterALevelReportSub;
	...
	public adapterALevelReportSub adapterALevelReportSub
	{
		get
		{
			return _adapterALevelReportSub;
		}
		set
		{
			_adapterALevelReportSub = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_adapterALevelReportSub != null && _adapterALevelReportSub.Connection != null)
			{
				return _adapterALevelReportSub.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_adapterALevelReportSub != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(ALevelReportSub dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_adapterALevelReportSub != null)
		{
			DataRow[] updatedRows = dataSet._ALevelReportSub.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _adapterALevelReportSub.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(ALevelReportSub dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_adapterALevelReportSub != null)
		{
			DataRow[] array = dataSet._ALevelReportSub.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _adapterALevelReportSub.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(ALevelReportSub dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_adapterALevelReportSub != null)
		{
			DataRow[] array = dataSet._ALevelReportSub.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _adapterALevelReportSub.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(ALevelReportSub dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_adapterALevelReportSub != null && !MatchTableAdapterConnection(_adapterALevelReportSub.Connection))
		{
		...
		try
		{
			if (_adapterALevelReportSub != null)
			{
				dictionary.Add(_adapterALevelReportSub, _adapterALevelReportSub.Connection);
				_adapterALevelReportSub.Connection = (SqlConnection)connection;
				_adapterALevelReportSub.Transaction = (SqlTransaction)dbTransaction;
				if (_adapterALevelReportSub.Adapter.AcceptChangesDuringUpdate)
				{
					_adapterALevelReportSub.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_adapterALevelReportSub.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_adapterALevelReportSub != null)
			{
				_adapterALevelReportSub.Connection = (SqlConnection)dictionary[_adapterALevelReportSub];
				_adapterALevelReportSub.Transaction = null;
			}
			if (0 < list3.Count)
			{
