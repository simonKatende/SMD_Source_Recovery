...
public class TableAdapterManager : Component
{
	...
	public tbl_StudTableAdapter tbl_StudTableAdapter
	{
		get
		{
			return _tbl_StudTableAdapter;
		}
		set
		{
			_tbl_StudTableAdapter = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_tbl_StudTableAdapter != null && _tbl_StudTableAdapter.Connection != null)
			{
				return _tbl_StudTableAdapter.Connection;
			}
			return null;
		}
		set
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(TheologyStudSource dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_tbl_StudTableAdapter != null)
		{
			DataRow[] updatedRows = dataSet.tbl_Stud.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _tbl_StudTableAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(TheologyStudSource dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_tbl_StudTableAdapter != null)
		{
			DataRow[] array = dataSet.tbl_Stud.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _tbl_StudTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(TheologyStudSource dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_tbl_StudTableAdapter != null)
		{
			DataRow[] array = dataSet.tbl_Stud.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _tbl_StudTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(TheologyStudSource dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_tbl_StudTableAdapter != null && !MatchTableAdapterConnection(_tbl_StudTableAdapter.Connection))
		{
		...
		try
		{
			if (_tbl_StudTableAdapter != null)
			{
				dictionary.Add(_tbl_StudTableAdapter, _tbl_StudTableAdapter.Connection);
				_tbl_StudTableAdapter.Connection = (SqlConnection)connection;
				_tbl_StudTableAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_tbl_StudTableAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_tbl_StudTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_tbl_StudTableAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_tbl_StudTableAdapter != null)
			{
				_tbl_StudTableAdapter.Connection = (SqlConnection)dictionary[_tbl_StudTableAdapter];
				_tbl_StudTableAdapter.Transaction = null;
			}
			if (0 < list3.Count)
			{
