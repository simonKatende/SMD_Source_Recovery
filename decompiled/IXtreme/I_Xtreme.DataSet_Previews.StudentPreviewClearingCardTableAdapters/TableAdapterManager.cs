...
public class TableAdapterManager : Component
{
	...
	private StudentClearanceSourceTableAdapter _studentClearanceSourceTableAdapter;
	...
	public StudentClearanceSourceTableAdapter StudentClearanceSourceTableAdapter
	{
		get
		{
			return _studentClearanceSourceTableAdapter;
		}
		set
		{
			_studentClearanceSourceTableAdapter = value;
		}
	}
	...
	public IDbConnection Connection
	{
		get
		{
			...
			if (_studentClearanceSourceTableAdapter != null && _studentClearanceSourceTableAdapter.Connection != null)
			{
				return _studentClearanceSourceTableAdapter.Connection;
			}
			return null;
		}
		set
	...
	public int TableAdapterInstanceCount
	{
		...
		{
			int num = 0;
			if (_studentClearanceSourceTableAdapter != null)
			{
				num++;
			}
			return num;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateUpdatedRows(StudentPreviewClearingCard dataSet, List<DataRow> allChangedRows, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_studentClearanceSourceTableAdapter != null)
		{
			DataRow[] updatedRows = dataSet.StudentClearanceSource.Select(null, null, DataViewRowState.ModifiedCurrent);
			updatedRows = GetRealUpdatedRows(updatedRows, allAddedRows);
			if (updatedRows != null && updatedRows.Length != 0)
			{
				num += _studentClearanceSourceTableAdapter.Update(updatedRows);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateInsertedRows(StudentPreviewClearingCard dataSet, List<DataRow> allAddedRows)
	{
		int num = 0;
		if (_studentClearanceSourceTableAdapter != null)
		{
			DataRow[] array = dataSet.StudentClearanceSource.Select(null, null, DataViewRowState.Added);
			if (array != null && array.Length != 0)
			{
				num += _studentClearanceSourceTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	private int UpdateDeletedRows(StudentPreviewClearingCard dataSet, List<DataRow> allChangedRows)
	{
		int num = 0;
		if (_studentClearanceSourceTableAdapter != null)
		{
			DataRow[] array = dataSet.StudentClearanceSource.Select(null, null, DataViewRowState.Deleted);
			if (array != null && array.Length != 0)
			{
				num += _studentClearanceSourceTableAdapter.Update(array);
	...
	[DebuggerNonUserCode]
	[GeneratedCode("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
	public virtual int UpdateAll(StudentPreviewClearingCard dataSet)
	{
		if (dataSet == null)
		{
		...
		if (_studentClearanceSourceTableAdapter != null && !MatchTableAdapterConnection(_studentClearanceSourceTableAdapter.Connection))
		{
		...
		try
		{
			if (_studentClearanceSourceTableAdapter != null)
			{
				dictionary.Add(_studentClearanceSourceTableAdapter, _studentClearanceSourceTableAdapter.Connection);
				_studentClearanceSourceTableAdapter.Connection = (SqlConnection)connection;
				_studentClearanceSourceTableAdapter.Transaction = (SqlTransaction)dbTransaction;
				if (_studentClearanceSourceTableAdapter.Adapter.AcceptChangesDuringUpdate)
				{
					_studentClearanceSourceTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
					list3.Add(_studentClearanceSourceTableAdapter.Adapter);
				}
			}
		...
		finally
		{
			...
			if (_studentClearanceSourceTableAdapter != null)
			{
				_studentClearanceSourceTableAdapter.Connection = (SqlConnection)dictionary[_studentClearanceSourceTableAdapter];
				_studentClearanceSourceTableAdapter.Transaction = null;
			}
			if (0 < list3.Count)
			{
