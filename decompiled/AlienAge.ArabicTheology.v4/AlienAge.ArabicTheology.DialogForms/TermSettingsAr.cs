...
public class TermSettingsAr : XtraForm
{
	...
	public TermSettingsAr()
	{
		InitializeComponent();
		WorkingSemesters.GetSemesters(new ComboBoxEdit[1] { cboSemester });
		cboSemester.SelectedItem = WorkingSemesters.GetWorkingSemester();
		LoadSetValues();
	...
	private void AddNewSettings()
	{
		try
		{
			...
			TermSettings.SetTermSettingsEn(cboClass.SelectedItem.ToString(), cboSemester.SelectedItem.ToString(), result, result2, result3, Convert.ToBoolean(chkProcessAs.EditValue), dtBegins.DateTime, txtReportHeader.Text.ToUpper(), "", SelectedSets());
			LoadSetValues();
		}
		catch (Exception ex)
		{
	...
	private void ChangeExistingSettings()
	{
		...
		using ProcessProgressEn processProgressEn = new ProcessProgressEn(result, result2, result3, pROCESSASPER, dtBegins.DateTime, txtReportHeader.Text.ToUpper(), "", SelectedSets(), cboClass.SelectedItem.ToString(), cboSemester.SelectedItem.ToString(), classLevel);
	...
	private void simpleButton1_Click(object sender, EventArgs e)
	{
		...
		else
		{
			...
			if (gridView1.GetRowCellValue(gridView1.GetFocusedDataSourceRowIndex(), "Sets").ToString() != SelectedSets() || Convert.ToBoolean(gridView1.GetRowCellValue(gridView1.GetFocusedDataSourceRowIndex(), "IsPercentage").ToString()) != Convert.ToBoolean(chkProcessAs.EditValue))
			{
	...
	private void LoadSetValues()
	{
		try
		{
			using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter($"SELECT * FROM tbl_TermSettings WHERE SemesterId='{cboSemester.SelectedItem}' Order By SemesterId,ClassIdEn", DataConnection.ConnectToDatabase()))
			{
				ds = new DataSet();
				sqlDataAdapter.Fill(ds, "TermSettings");
				gridControl1.DataSource = ds.Tables[0].DefaultView;
			}
			gridView1.Columns["auto"].Visible = false;
			gridView1.Columns["ClassIdEn"].Caption = "Class";
			gridView1.Columns["SemesterId"].Caption = "Semester";
			gridView1.Columns["IsPercentage"].Caption = "Is (%)";
			gridView1.Columns["SemesterId"].Width = 80;
			gridView1.Columns["TermEndsOn"].Visible = false;
			gridView1.Columns["TermBeginsOn"].Visible = false;
			gridView1.Columns["ReportHeader"].Visible = false;
			gridView1.Columns["Sets"].Visible = false;
			gridView1.Columns["SemesterId"].GroupIndex = 0;
	...
	private void gridView1_DoubleClick(object sender, EventArgs e)
	{
		if (gridView1.GetFocusedDataSourceRowIndex() > -1)
		{
			...
			cboSemester.SelectedItem = dataRow["SemesterId"].ToString();
	...
	private void InitializeComponent()
	{
		...
		this.layoutControl1.Controls.Add(this.cboSemester);
		...
		this.layoutControl1.Size = new System.Drawing.Size(1005, 657);
		this.layoutControl1.TabIndex = 0;
		this.layoutControl1.Text = "layoutControl1";
		this.txtReportHeader.Location = new System.Drawing.Point(5, 365);
		this.txtReportHeader.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		...
		this.txtReportHeader.Size = new System.Drawing.Size(352, 32);
		this.txtReportHeader.StyleController = this.layoutControl1;
		this.txtReportHeader.TabIndex = 34;
		this.dtBegins.EditValue = null;
		this.dtBegins.Location = new System.Drawing.Point(10, 576);
		this.dtBegins.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		...
		this.dtBegins.Size = new System.Drawing.Size(342, 32);
		this.dtBegins.StyleController = this.layoutControl1;
		this.dtBegins.TabIndex = 32;
		this.cboSemester.Location = new System.Drawing.Point(5, 300);
		this.cboSemester.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		this.cboSemester.Name = "cboSemester";
		this.cboSemester.Properties.Appearance.Font = new System.Drawing.Font("Tahoma", 10f);
		this.cboSemester.Properties.Appearance.Options.UseFont = true;
		this.cboSemester.Properties.AppearanceDropDown.Font = new System.Drawing.Font("Tahoma", 10f);
		this.cboSemester.Properties.AppearanceDropDown.Options.UseFont = true;
		this.cboSemester.Properties.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.HotFlat;
		...
		this.cboSemester.Size = new System.Drawing.Size(352, 32);
		this.cboSemester.StyleController = this.layoutControl1;
		this.cboSemester.TabIndex = 31;
		this.cboSemester.EditValueChanged += new System.EventHandler(cboSemester_EditValueChanged);
		this.cboClass.Location = new System.Drawing.Point(5, 235);
		...
		this.cboClass.Size = new System.Drawing.Size(352, 32);
		...
		this.panelControl1.Location = new System.Drawing.Point(363, 619);
		this.panelControl1.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		this.panelControl1.Name = "panelControl1";
		this.panelControl1.Size = new System.Drawing.Size(364, 33);
		this.panelControl1.TabIndex = 29;
		this.gridControl1.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(5, 7, 5, 7);
		this.gridControl1.Location = new System.Drawing.Point(363, 5);
		this.gridControl1.MainView = this.gridView1;
		this.gridControl1.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		this.gridControl1.Name = "gridControl1";
		this.gridControl1.Size = new System.Drawing.Size(637, 608);
		...
		this.simpleButton2.Location = new System.Drawing.Point(733, 619);
		this.simpleButton2.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		this.simpleButton2.Name = "simpleButton2";
		this.simpleButton2.Size = new System.Drawing.Size(267, 33);
		...
		this.memoEdit1.Size = new System.Drawing.Size(352, 159);
		this.memoEdit1.StyleController = this.layoutControl1;
		this.memoEdit1.TabIndex = 26;
		this.chkProcessAs.Location = new System.Drawing.Point(5, 5);
		this.chkProcessAs.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		...
		this.chkProcessAs.Size = new System.Drawing.Size(352, 32);
		...
		this.chkMOT.Location = new System.Drawing.Point(10, 473);
		this.chkMOT.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		...
		this.chkMOT.Size = new System.Drawing.Size(35, 23);
		...
		this.chkEOT.Location = new System.Drawing.Point(10, 511);
		this.chkEOT.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		...
		this.chkEOT.Size = new System.Drawing.Size(35, 23);
		...
		this.chkBOT.Location = new System.Drawing.Point(10, 435);
		this.chkBOT.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		...
		this.chkBOT.Size = new System.Drawing.Size(35, 23);
		...
		this.simpleButton1.Location = new System.Drawing.Point(5, 619);
		this.simpleButton1.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		this.simpleButton1.Name = "simpleButton1";
		this.simpleButton1.Size = new System.Drawing.Size(352, 33);
		this.simpleButton1.StyleController = this.layoutControl1;
		this.simpleButton1.TabIndex = 9;
		this.simpleButton1.Text = "Add Settings";
		this.simpleButton1.Click += new System.EventHandler(simpleButton1_Click);
		this.txtEOT.Location = new System.Drawing.Point(93, 511);
		this.txtEOT.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		...
		this.txtEOT.Size = new System.Drawing.Size(259, 32);
		...
		this.txtMOT.Location = new System.Drawing.Point(97, 473);
		...
		this.txtMOT.Size = new System.Drawing.Size(255, 32);
		...
		this.txtBOT.Location = new System.Drawing.Point(94, 435);
		this.txtBOT.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		...
		this.txtBOT.Size = new System.Drawing.Size(258, 32);
		...
		this.layoutControlGroup1.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[10] { this.layoutControlItem5, this.layoutControlGroup2, this.layoutControlItem8, this.layoutControlItem9, this.layoutControlItem6, this.layoutControlItem7, this.layoutControlItem10, this.layoutControlItem11, this.layoutControlItem12, this.layoutControlItem15 });
		this.layoutControlGroup1.Name = "layoutControlGroup1";
		this.layoutControlGroup1.Padding = new DevExpress.XtraLayout.Utils.Padding(2, 2, 2, 2);
		this.layoutControlGroup1.Size = new System.Drawing.Size(1005, 657);
		this.layoutControlGroup1.TextVisible = false;
		this.layoutControlItem5.Control = this.simpleButton1;
		this.layoutControlItem5.CustomizationFormText = "layoutControlItem5";
		this.layoutControlItem5.Location = new System.Drawing.Point(0, 614);
		this.layoutControlItem5.Name = "layoutControlItem5";
		this.layoutControlItem5.Size = new System.Drawing.Size(358, 39);
		...
		this.layoutControlGroup2.Size = new System.Drawing.Size(358, 216);
		...
		this.layoutControlItem2.Size = new System.Drawing.Size(307, 38);
		...
		this.layoutControlItem4.Location = new System.Drawing.Point(41, 38);
		this.layoutControlItem4.Name = "layoutControlItem4";
		this.layoutControlItem4.Size = new System.Drawing.Size(307, 38);
		this.layoutControlItem4.Text = "MOT";
		this.layoutControlItem4.TextAlignMode = DevExpress.XtraLayout.TextAlignModeItem.AutoSize;
		this.layoutControlItem4.TextSize = new System.Drawing.Size(41, 24);
		...
		this.layoutControlItem3.Location = new System.Drawing.Point(41, 76);
		this.layoutControlItem3.Name = "layoutControlItem3";
		this.layoutControlItem3.Size = new System.Drawing.Size(307, 38);
		this.layoutControlItem3.Text = "EOT";
		this.layoutControlItem3.TextAlignMode = DevExpress.XtraLayout.TextAlignModeItem.AutoSize;
		this.layoutControlItem3.TextSize = new System.Drawing.Size(37, 24);
		this.layoutControlItem3.TextToControlDistance = 5;
		this.layoutControlItem18.Control = this.chkBOT;
		this.layoutControlItem18.CustomizationFormText = "layoutControlItem18";
		this.layoutControlItem18.Location = new System.Drawing.Point(0, 0);
		this.layoutControlItem18.Name = "layoutControlItem18";
		this.layoutControlItem18.Size = new System.Drawing.Size(41, 38);
		...
		this.layoutControlItem20.Size = new System.Drawing.Size(41, 38);
		...
		this.layoutControlItem19.Size = new System.Drawing.Size(41, 38);
		...
		this.layoutControlItem13.Size = new System.Drawing.Size(348, 65);
		this.layoutControlItem13.Text = "Next Term Begins on:";
		this.layoutControlItem13.TextLocation = DevExpress.Utils.Locations.Top;
		this.layoutControlItem13.TextSize = new System.Drawing.Size(194, 24);
		this.layoutControlItem8.Control = this.chkProcessAs;
		this.layoutControlItem8.CustomizationFormText = "layoutControlItem8";
		this.layoutControlItem8.Location = new System.Drawing.Point(0, 0);
		this.layoutControlItem8.Name = "layoutControlItem8";
		this.layoutControlItem8.Size = new System.Drawing.Size(358, 38);
		...
		this.layoutControlItem9.Size = new System.Drawing.Size(358, 165);
		this.layoutControlItem9.TextSize = new System.Drawing.Size(0, 0);
		this.layoutControlItem9.TextVisible = false;
		this.layoutControlItem6.Control = this.gridControl1;
		this.layoutControlItem6.CustomizationFormText = "layoutControlItem6";
		this.layoutControlItem6.Location = new System.Drawing.Point(358, 0);
		this.layoutControlItem6.Name = "layoutControlItem6";
		this.layoutControlItem6.Size = new System.Drawing.Size(643, 614);
		this.layoutControlItem6.TextSize = new System.Drawing.Size(0, 0);
		this.layoutControlItem6.TextVisible = false;
		this.layoutControlItem7.Control = this.simpleButton2;
		this.layoutControlItem7.CustomizationFormText = "layoutControlItem7";
		this.layoutControlItem7.Location = new System.Drawing.Point(728, 614);
		this.layoutControlItem7.Name = "layoutControlItem7";
		this.layoutControlItem7.Size = new System.Drawing.Size(273, 39);
		this.layoutControlItem7.TextSize = new System.Drawing.Size(0, 0);
		this.layoutControlItem7.TextVisible = false;
		this.layoutControlItem10.Control = this.panelControl1;
		this.layoutControlItem10.CustomizationFormText = "layoutControlItem10";
		this.layoutControlItem10.Location = new System.Drawing.Point(358, 614);
		this.layoutControlItem10.Name = "layoutControlItem10";
		this.layoutControlItem10.Size = new System.Drawing.Size(370, 39);
		...
		this.layoutControlItem11.Size = new System.Drawing.Size(358, 65);
		this.layoutControlItem11.Text = "Class:";
		this.layoutControlItem11.TextLocation = DevExpress.Utils.Locations.Top;
		this.layoutControlItem11.TextSize = new System.Drawing.Size(194, 24);
		this.layoutControlItem12.AppearanceItemCaption.Font = new System.Drawing.Font("Tahoma", 10f);
		this.layoutControlItem12.AppearanceItemCaption.Options.UseFont = true;
		this.layoutControlItem12.Control = this.cboSemester;
		...
		this.layoutControlItem12.Size = new System.Drawing.Size(358, 65);
		this.layoutControlItem12.Text = "Semester";
		this.layoutControlItem12.TextLocation = DevExpress.Utils.Locations.Top;
		this.layoutControlItem12.TextSize = new System.Drawing.Size(194, 24);
		...
		this.layoutControlItem15.Location = new System.Drawing.Point(0, 333);
		this.layoutControlItem15.Name = "layoutControlItem15";
		this.layoutControlItem15.Size = new System.Drawing.Size(358, 65);
		this.layoutControlItem15.Text = "Report Header";
		this.layoutControlItem15.TextLocation = DevExpress.Utils.Locations.Top;
		this.layoutControlItem15.TextSize = new System.Drawing.Size(194, 24);
		this.timer1.Enabled = true;
		this.timer1.Tick += new System.EventHandler(timer1_Tick);
		base.AutoScaleDimensions = new System.Drawing.SizeF(9f, 19f);
		base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		base.ClientSize = new System.Drawing.Size(1005, 657);
		base.Controls.Add(this.layoutControl1);
		base.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
		base.Margin = new System.Windows.Forms.Padding(4, 5, 4, 5);
		base.MaximizeBox = false;
		base.Name = "TermSettingsAr";
		base.ShowIcon = false;
