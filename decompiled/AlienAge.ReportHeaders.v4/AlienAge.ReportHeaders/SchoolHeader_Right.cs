...
public class SchoolHeader_Right : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		lblMotto.LocationFloat = new PointFloat(119.79f, 86.5f);
		...
		lblFullContact.LocationFloat = new PointFloat(119.79f, 40.10421f);
		...
		lblSchoolName.LocationFloat = new PointFloat(119.79f, 0f);
		...
		lblLocation.LocationFloat = new PointFloat(119.79f, 64.10421f);
		lblLocation.Multiline = true;
		lblLocation.Name = "lblLocation";
		lblLocation.Padding = new PaddingInfo(0, 2, 0, 0, 100f);
		lblLocation.SizeF = new SizeF(655.21f, 20.99998f);
