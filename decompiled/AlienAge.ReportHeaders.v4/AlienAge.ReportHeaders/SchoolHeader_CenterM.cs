...
public class SchoolHeader_CenterM : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		lblLocation.LocationFloat = new PointFloat(2.999997f, 62f);
		lblLocation.Name = "lblLocation";
		lblLocation.Padding = new PaddingInfo(0, 0, 0, 0, 100f);
		lblLocation.SizeF = new SizeF(339f, 20.99999f);
		...
		lblMotto.LocationFloat = new PointFloat(435f, 62f);
		lblMotto.Name = "lblMotto";
		lblMotto.Padding = new PaddingInfo(0, 0, 0, 0, 100f);
		lblMotto.SizeF = new SizeF(339f, 20.99999f);
		...
		lblTelephone.LocationFloat = new PointFloat(435f, 39f);
		lblTelephone.Name = "lblTelephone";
		lblTelephone.Padding = new PaddingInfo(0, 0, 0, 0, 100f);
		lblTelephone.SizeF = new SizeF(339f, 21f);
		...
		lblSchoolName.SizeF = new SizeF(776f, 35f);
		...
		xrPictureBox1.LocationFloat = new PointFloat(347.5f, 38f);
		...
		lblBox.LocationFloat = new PointFloat(2.999997f, 39f);
		lblBox.Name = "lblBox";
		lblBox.Padding = new PaddingInfo(0, 0, 0, 0, 100f);
		lblBox.SizeF = new SizeF(339f, 21f);
