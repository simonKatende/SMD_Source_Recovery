...
public class SchoolHeaderM : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		Detail.Controls.AddRange(new XRControl[5] { lblMotto, lblSchoolName, lblFullContact, lblLocation, xrPictureBox1 });
		Detail.HeightF = 101.6667f;
		Detail.Name = "Detail";
		...
		lblMotto.CanShrink = true;
		lblMotto.Font = new DXFont("Times New Roman", 12f, DXFontStyle.Italic);
		lblMotto.LocationFloat = new PointFloat(0f, 76.99998f);
		lblMotto.Multiline = true;
		lblMotto.Name = "lblMotto";
		lblMotto.Padding = new PaddingInfo(2, 0, 0, 0, 100f);
		lblMotto.SizeF = new SizeF(655.4583f, 20.99999f);
		...
		lblSchoolName.Font = new DXFont("Microsoft Sans Serif", 20f, DXFontStyle.Bold);
		...
		lblSchoolName.Padding = new PaddingInfo(2, 0, 0, 0, 100f);
		lblSchoolName.SizeF = new SizeF(655.4583f, 35f);
		...
		lblSchoolName.TextAlignment = TextAlignment.MiddleLeft;
		lblFullContact.BackColor = Color.Transparent;
		lblFullContact.CanShrink = true;
		lblFullContact.Font = new DXFont("Microsoft Sans Serif", 12f, DXFontStyle.Regular, DXGraphicsUnit.Point, new DXFontAdditionalProperty[1]
		{
			new DXFontAdditionalProperty("GdiCharSet", (byte)0)
		});
		lblFullContact.LocationFloat = new PointFloat(0f, 35.00001f);
		lblFullContact.Multiline = true;
		lblFullContact.Name = "lblFullContact";
		lblFullContact.Padding = new PaddingInfo(2, 0, 0, 0, 100f);
		lblFullContact.SizeF = new SizeF(655.4583f, 21f);
		...
		lblFullContact.TextAlignment = TextAlignment.MiddleLeft;
		lblLocation.BackColor = Color.Transparent;
		lblLocation.CanShrink = true;
		...
		lblLocation.LocationFloat = new PointFloat(0f, 56f);
		lblLocation.Multiline = true;
		lblLocation.Name = "lblLocation";
		lblLocation.Padding = new PaddingInfo(2, 0, 0, 0, 100f);
		lblLocation.SizeF = new SizeF(655.4583f, 20.99999f);
		...
		lblLocation.TextAlignment = TextAlignment.MiddleLeft;
		xrPictureBox1.BackColor = Color.Transparent;
		xrPictureBox1.LocationFloat = new PointFloat(669f, 0f);
		xrPictureBox1.Name = "xrPictureBox1";
		xrPictureBox1.SizeF = new SizeF(107f, 100f);
