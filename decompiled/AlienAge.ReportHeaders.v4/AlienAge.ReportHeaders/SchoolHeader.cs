...
public class SchoolHeader : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		lblMotto.LocationFloat = new PointFloat(0f, 85.00002f);
		lblMotto.Multiline = true;
		lblMotto.Name = "lblMotto";
		lblMotto.Padding = new PaddingInfo(2, 0, 0, 0, 100f);
		lblMotto.SizeF = new SizeF(655.21f, 20.99999f);
		...
		lblSchoolName.SizeF = new SizeF(655.21f, 37f);
		...
		lblLocation.SizeF = new SizeF(655.21f, 20.99999f);
		...
		xrPictureBox1.LocationFloat = new PointFloat(655.21f, 0f);
		xrPictureBox1.Name = "xrPictureBox1";
		xrPictureBox1.SizeF = new SizeF(119.79f, 110f);
