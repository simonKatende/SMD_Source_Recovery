...
public class SchoolHeader_SM_L : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		Detail.Controls.AddRange(new XRControl[4] { lblSchoolName, lblFullContact, lblLocation, xrPictureBox1 });
		Detail.HeightF = 77f;
		Detail.Name = "Detail";
		...
		lblSchoolName.Padding = new PaddingInfo(3, 3, 0, 0, 100f);
		lblSchoolName.SizeF = new SizeF(460.22f, 27.5f);
		...
		lblFullContact.LocationFloat = new PointFloat(0f, 30f);
		lblFullContact.Multiline = true;
		lblFullContact.Name = "lblFullContact";
		lblFullContact.Padding = new PaddingInfo(3, 3, 0, 0, 100f);
		lblFullContact.SizeF = new SizeF(460.22f, 21f);
		...
		lblLocation.LocationFloat = new PointFloat(0f, 54f);
		lblLocation.Multiline = true;
		lblLocation.Name = "lblLocation";
		lblLocation.Padding = new PaddingInfo(3, 3, 0, 0, 100f);
		lblLocation.SizeF = new SizeF(460.22f, 21f);
		...
		xrPictureBox1.LocationFloat = new PointFloat(462.22f, 1f);
