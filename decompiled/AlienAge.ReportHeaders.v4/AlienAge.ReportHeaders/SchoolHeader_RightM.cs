...
public class SchoolHeader_RightM : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		Detail.Controls.AddRange(new XRControl[5] { lblMotto, lblFullContact, lblSchoolName, lblLocation, xrPictureBox1 });
		Detail.Name = "Detail";
		...
		lblMotto.LocationFloat = new PointFloat(119.125f, 76.99997f);
		lblMotto.Multiline = true;
		lblMotto.Name = "lblMotto";
		lblMotto.Padding = new PaddingInfo(0, 2, 0, 0, 100f);
		lblMotto.SizeF = new SizeF(656.875f, 20.99999f);
		...
		lblMotto.Text = "Motto";
		lblMotto.TextAlignment = TextAlignment.MiddleRight;
		...
		lblFullContact.LocationFloat = new PointFloat(119.125f, 35.00001f);
		lblFullContact.Multiline = true;
		lblFullContact.Name = "lblFullContact";
		lblFullContact.Padding = new PaddingInfo(0, 2, 0, 0, 100f);
		lblFullContact.SizeF = new SizeF(656.875f, 21f);
		...
		lblSchoolName.LocationFloat = new PointFloat(119.125f, 0f);
		lblSchoolName.Name = "lblSchoolName";
		lblSchoolName.Padding = new PaddingInfo(0, 2, 0, 0, 100f);
		lblSchoolName.SizeF = new SizeF(656.875f, 35f);
		...
		lblLocation.LocationFloat = new PointFloat(119.125f, 56f);
		lblLocation.Multiline = true;
		lblLocation.Name = "lblLocation";
		lblLocation.Padding = new PaddingInfo(0, 2, 0, 0, 100f);
		lblLocation.SizeF = new SizeF(656.875f, 20.99999f);
