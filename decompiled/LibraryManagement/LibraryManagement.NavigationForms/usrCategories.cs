...
public class usrCategories : XtraUserControl
{
	...
	public usrCategories()
	{
		InitializeComponent();
		LoadCategories();
	}

	public void CategoryCallBackFN(bool timerStatus)
	{
	...
	private void LoadCategories()
	{
		try
		{
			using SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("SELECT * FROM tbl_BookCategories", DataConnection.ConnectToDatabase());
	...
	private void gridView1_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
	{
		...
		EditableFields.SetEditableFieldValues(Convert.ToInt64(dataRow["CatId"].ToString()), "Categories");
	}
	...
	private void InitializeComponent()
	{
		...
		this.layoutControl1.Size = new System.Drawing.Size(658, 530);
		this.layoutControl1.TabIndex = 0;
		this.layoutControl1.Text = "layoutControl1";
		this.gridControl1.Location = new System.Drawing.Point(4, 4);
		this.gridControl1.MainView = this.gridView1;
		this.gridControl1.Name = "gridControl1";
		this.gridControl1.Size = new System.Drawing.Size(650, 522);
		this.gridControl1.TabIndex = 4;
		this.gridControl1.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[1] { this.gridView1 });
		this.gridView1.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[1] { this.gridColCategory });
		...
		this.layoutControlGroup1.Size = new System.Drawing.Size(658, 530);
		...
		this.layoutControlItem1.Size = new System.Drawing.Size(654, 526);
		...
		base.Name = "usrCategories";
		base.Size = new System.Drawing.Size(658, 530);
